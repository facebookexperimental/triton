...
constexpr static char AttrWarpsGemmName[] = "ttg.warps_gemm";
constexpr static char AttrWarpsLoadName[] = "ttg.warps_load";
constexpr static char AttrWarpsComputationName[] = "ttg.warps_computation";
constexpr static char AttrWarpsEpilogueName[] = "ttg.warps_epilogue";
