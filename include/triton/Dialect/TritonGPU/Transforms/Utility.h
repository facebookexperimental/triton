...
// Returns true if the tensor type has any non-power-of-2 dimension.
// Optimization passes that assume pow2 layouts (RemoveLayoutConversions,
// ReduceDataDuplication, Prefetch, CoalesceAsyncCopy) should skip tensors
// where this returns true to avoid crashes in the layout algebra.
