...
inline const std::set<std::string> CACHE_INVALIDATING_ENV_VARS = {
    ...
    "TRITON_WS_SMEM_PLAN_TOPK",
    "TRITON_WS_SMEM_PLAN_PICK",
    "TRITON_WS_TMEM_PLAN_TOPK",
    "TRITON_WS_TMEM_PLAN_PICK",
    "TRITON_WS_MEM_PLAN_TOPK_DUMP",
    "TRITON_WS_MEMORY_SPACE_TOPK",
    "TRITON_WS_MEMORY_SPACE_PICK",
