---
name: paper-joint-manual-cuda
description: >
  Guide agent-assisted manual B200 CUDA C++ lowering from validated
  paper-joint-pipelined-ir-v3 artifacts, with explicit clean-room provenance,
...
metadata:
  ...
  apply_to_user_prompt: '(?i)(paper.?joint.*(manual|cuda|b200|lower)|manual.*cuda.*paper.?joint|paper-joint-(pipelined-ir-v3|handoff-v2)|agent-assisted-manual-cuda)'
  apply_to_content: 'paper-joint-(pipelined-ir-v3|handoff-v2)'
---

# Paper-Joint Manual B200 CUDA

Use this skill only for an expert-reviewed, agent-assisted manual CUDA C++
implementation starting from a validated `paper-joint-pipelined-ir-v3`
