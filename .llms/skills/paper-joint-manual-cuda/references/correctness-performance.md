...
- per-warp dynamic issue order agrees with the reviewed mapping;
...
- A speedup or slowdown is a result for this manual implementation, not proof
  or disproof of the paper's scheduling algorithm.
- Do not attribute performance to the paper unless the mapping is faithful and
  all other manual choices are disclosed.
...
the hashed paper IR, compared with FA4/FA3 as black boxes." It is not
"paper-generated CUDA matched FA4."
