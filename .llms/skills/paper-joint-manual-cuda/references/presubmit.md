...
- [ ] The input schema is exactly `paper-joint-pipelined-ir-v3`.
...
- [ ] The physical warp assignment, per-warp issue order, and all pipeline
      regions match the paper artifact.
...
> B200 CUDA C++ lowering of the hashed `paper-joint-pipelined-ir-v3` artifact,
...
Do not call the implementation automatically lowered, solver-generated, or
paper-generated.
