...
```json
{
  "schema_version": "twill-manual-cuda-sync-v1",
...
- producer/consumer physical groups, warps, lanes, and CTA ranks;
...
2. Same-group edges whose producer is asynchronous, such as TMA or TCGEN05.
...
dependency waits, async-consumer waits, per-group issue order, and
