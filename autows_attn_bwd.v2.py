...
def _attn_bwd(desc_q, desc_qt, desc_k, desc_kt, desc_v, sm_scale, desc_do, desc_dot, desc_dq, desc_dk, desc_dv, desc_m, desc_delta, stride_z, stride_h, stride_tok, BATCH, H, N_CTX):
  ...
  with tlx.async_tasks():
    ...
    with tlx.async_task(num_warps=1, registers=88):
      ...
      tlx.async_descriptor_load(desc_k_131, k_188, [k_179, 0], k_185)
      ...
      tlx.async_descriptor_load(desc_kt_132, kt_198, [kt_191, kt_194], kt_197)
      tlx.barrier_wait(v_199, 1)
      v_201 = tlx.remote_view(v_200, k_184)
      tlx.barrier_expect_bytes(v_200, 65536)
      tlx.async_descriptor_load(desc_v_133, v_202, [k_179, 0], v_201)
      num_steps = N_CTX_94 // 128
      curr_m = num_steps > 0
      ...
      tlx.async_descriptor_load(desc_qt_134, qT_208, [qt_203, 0], qT_206)
      tlx.barrier_wait(dpT_209, 1)
      dpT_211 = tlx.remote_view(dpT_210, k_184)
      tlx.barrier_expect_bytes(dpT_210, 32768)
      tlx.async_descriptor_load(desc_dot_140, dpT_212, [qt_203, 0], dpT_211)
      ...
      tlx.async_descriptor_load(desc_do_139, do_219, [off_bh_177, kt_194], do_218)
      ...
      for arg135 in range(0, curr_m_220, 1):
        ...
        tlx.barrier_expect_bytes(qT_205, 32768)
        tlx.async_descriptor_load(desc_qt_134, qT_208, [qt_226, 0], qT_206)
        q_231 = arg137 & 1
        q_234 = q_231 ^ True
        tlx.barrier_wait(q_233, q_234)
        q_237 = tlx.remote_view(q_236, k_184)
        tlx.barrier_expect_bytes(q_236, 32768)
        tlx.async_descriptor_load(desc_q_135, q_238, [arg138, kt_194], q_237)
        Di_240 = q_231 ^ True
        ...
        tlx.barrier_expect_bytes(dpT_210, 32768)
        tlx.async_descriptor_load(desc_dot_140, dpT_212, [qt_226, 0], dpT_211)
        ...
        tlx.barrier_expect_bytes(do_217, 32768)
        tlx.async_descriptor_load(desc_do_139, do_219, [qt_224, kt_194], do_218)
        arg136 = curr_m_222
        arg137 = accum_cnt
        arg138 = qt_224
        arg139 = offs_m_start
      if curr_m:
        ...
        tlx.async_descriptor_load(desc_q_135, q_229, [arg138, kt_194], q_228)
        Di_231 = q_222 ^ True
