...
See also [AutoWS](compiler.md) and [torchTLX](torchtlx.md).

## Contents

- [Hardware tags](#hardware-tags)
- [Memory](#memory)
- [Global memory access](#global-memory-access)
- [Async memory access](#async-memory-access)
- [Tensor core operations](#tensor-core-operations)
- [Synchronization](#synchronization)
- [Warp specialization](#warp-specialization)
- [Clusters and Cluster Launch Control](#clusters-and-cluster-launch-control)
- [Layout control and diagnostics](#layout-control-and-diagnostics)
- [Other operations](#other-operations)
- [Kernels implemented with TLX](#kernels-implemented-with-tlx)
- [Testing](#testing)
...
- `buffer = tlx.local_slice(buffer, offsets=[m, n], shapes=[M, N])` **[sm90+, gfx942+]**
...
- `tlx.clc_producer(context, p_producer=phase, multi_ctas=False)` **[sm100]**
...
- `tile_id = tlx.clc_consumer(context, p_consumer=phase, multi_ctas=False, k=0, return_3d=False)` **[sm100]**
