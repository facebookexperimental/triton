...
[fbtriton](../README.md) &rsaquo; Compiler
...
- [AutoWS — automatic warp specialization](#autows--automatic-warp-specialization)
- [Reduction ordering](#reduction-ordering)
...
Where [TLX](tlx.md) has you write warp specialization by hand with
...
Additional design notes live in [`docs/design/`](design/), including
...
[Reduction Ordering in Triton](design/reduction-ordering.md).
