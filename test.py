...
triton_poi_fused_max_pool2d_with_indices_max_pool2d_with_indices_backward_0 = async_compile.triton('triton_poi_fused_max_pool2d_with_indices_max_pool2d_with_indices_backward_0', '''
import triton
import triton.language as tl
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            # Topologically Sorted Source Nodes: [max_pool2d], Original ATen: [aten.max_pool2d_with_indices, aten.max_pool2d_with_indices_backward]
            # [Provenance debug handles] triton_poi_fused_max_pool2d_with_indices_max_pool2d_with_indices_backward_0:229
            stream0 = get_raw_stream(0)
            triton_poi_fused_max_pool2d_with_indices_max_pool2d_with_indices_backward_0.run(getitem_1, tangents_1, buf0, 36, stream=stream0)
            del getitem_1
            del tangents_1
