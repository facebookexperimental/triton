...
_codegen_backends = os.getenv("TRITON_CODEGEN_BACKENDS", "nvidia;amd;cpu").split(";")
backends = [*BackendInstaller.copy(_codegen_backends), *BackendInstaller.copy_externals()]
