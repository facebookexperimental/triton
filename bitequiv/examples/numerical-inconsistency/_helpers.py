...
upstream commit (see ``UPSTREAM_COMMIT.txt``), where ``bitequiv/equivalence.py``
and ``bitequiv/examples/layout_numerics/`` do NOT exist yet. So we carry our own
copy of the IR-capture primitives here and import nothing from ``bitequiv.*``.
