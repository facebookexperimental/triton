...
if __name__ == "__main__":
    if is_blackwell():
        print("Test op...")
        test_op(Z=8, H=4, N_CTX=16384, HEAD_DIM=128, causal=False, mode="fwd", baseVariant="ws", provider="triton-fp8", SUBTILING=True, VECT_MUL=1, FADD2_REDUCE=False, bwd_config_idx=0)
