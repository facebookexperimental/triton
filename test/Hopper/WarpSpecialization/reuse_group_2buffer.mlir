...
// CHECK: tt.func public @_attn_bwd_persist{{.*}}nvws.test.channel_cycle_edge_count = 123 : i64
// CHECK-SAME: nvws.test.channel_cycle_event_count = 45 : i64
// CHECK-SAME: nvws.test.channel_cycle_supported_channels = 11 : i64
// CHECK-SAME: nvws.test.channel_cycle_tmem_a2_groups = 2 : i64
// CHECK-SAME: nvws.test.channel_cycle_unsupported_channels = 6 : i64
