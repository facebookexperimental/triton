...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @reuse_war_async(%desc_k: !tt.tensordesc<128x128xf16, #shared>, %desc_v: !tt.tensordesc<128x128xf16, #shared>) attributes {noinline = false} {
    ...
    %qload = tt.descriptor_load %desc_k[%c0_i32, %c0_i32] {async_task_id = array<i32: 1>} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked1>
    ...
    scf.for %t = %c0_i32 to %c128_i32 step %c128_i32  : i32 {
      %r:4 = scf.for %i = %c0_i32 to %c1024_i32 step %c128_i32 iter_args(%off = %c0_i32, %uc = %false, %qkt = %qk_tok, %at = %acc_tok) -> (i32, i1, !ttg.async.token, !ttg.async.token)  : i32 {
        ...
        %kl = tt.descriptor_load %desc_k[%off, %c0_i32] {async_task_id = array<i32: 1>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked1>
        ...
        %vl = tt.descriptor_load %desc_v[%off, %c0_i32] {async_task_id = array<i32: 1>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked1>
