...
module attributes {"ttg.cluster-dim-x" = 1 : i32, "ttg.cluster-dim-y" = 1 : i32, "ttg.cluster-dim-z" = 1 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @tma_store_local_store_order(%c_desc: !tt.tensordesc<128x128xf16, #shared>) attributes {noinline = false} {
    ...
    tt.descriptor_store %c_desc[%c0_i32, %c0_i32], %c0_a_store {async_task_id = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared>, tensor<128x128xf16, #blocked>
    tt.descriptor_store %c_desc[%row1, %c0_i32], %c0_b_store {async_task_id = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared>, tensor<128x128xf16, #blocked>
    ...
    tt.descriptor_store %c_desc[%c0_i32, %col1], %c1_a_store {async_task_id = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared>, tensor<128x128xf16, #blocked>
    tt.descriptor_store %c_desc[%row1, %col1], %c1_b_store {async_task_id = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared>, tensor<128x128xf16, #blocked>
    tt.return
  }
}
