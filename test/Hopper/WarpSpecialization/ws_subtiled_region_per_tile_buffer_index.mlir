...
module attributes {"ttg.cluster-dim-x" = 1 : i32, "ttg.cluster-dim-y" = 1 : i32, "ttg.cluster-dim-z" = 1 : i32, ttg.early_tma_store_lowering = true, ttg.min_reg_auto_ws = 24 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  ...
  tt.func public @matmul_kernel_tma_persistent_ws(%arg0: !tt.tensordesc<tensor<128x64xf16, #shared>>, %arg1: i32, %arg2: i32, %arg3: i64, %arg4: i64, %arg5: !tt.tensordesc<tensor<128x64xf16, #shared>>, %arg6: i32, %arg7: i32, %arg8: i64, %arg9: i64, %arg10: !tt.tensordesc<tensor<128x32xf16, #shared1>>, %arg11: i32, %arg12: i32, %arg13: i64, %arg14: i64, %arg15: i32 {tt.divisibility = 16 : i32}, %arg16: i32 {tt.divisibility = 16 : i32}, %arg17: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    scf.for %arg18 = %0 to %7 step %c148_i32  : i32 {
      ...
      %s0 = ttng.async_tma_copy_local_to_global %arg10[%17, %18] %a0 {ttg.partition = array<i32: 2>} : !tt.tensordesc<tensor<128x32xf16, #shared1>>, !ttg.memdesc<128x32xf16, #shared1, #smem, mutable> -> !ttg.async.token
      ...
      %s1 = ttng.async_tma_copy_local_to_global %arg10[%17, %cn1] %a1 {ttg.partition = array<i32: 2>} : !tt.tensordesc<tensor<128x32xf16, #shared1>>, !ttg.memdesc<128x32xf16, #shared1, #smem, mutable> -> !ttg.async.token
      ...
      %s2 = ttng.async_tma_copy_local_to_global %arg10[%17, %cn2] %a2 {ttg.partition = array<i32: 2>} : !tt.tensordesc<tensor<128x32xf16, #shared1>>, !ttg.memdesc<128x32xf16, #shared1, #smem, mutable> -> !ttg.async.token
      ...
      %s3 = ttng.async_tma_copy_local_to_global %arg10[%17, %cn3] %a3 {ttg.partition = array<i32: 2>} : !tt.tensordesc<tensor<128x32xf16, #shared1>>, !ttg.memdesc<128x32xf16, #shared1, #smem, mutable> -> !ttg.async.token
