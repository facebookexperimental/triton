...
module attributes {"ttg.cluster-dim-x" = 1 : i32, "ttg.cluster-dim-y" = 1 : i32, "ttg.cluster-dim-z" = 1 : i32, ttg.early_tma_store_lowering = true, ttg.min_reg_auto_ws = 24 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  ...
  ^bb2:  // pred: ^bb0
    ...
    %30 = tt.make_tensor_descriptor %arg0, [%arg4, %28], [%29, %c1_i64] {ttg.partition = array<i32: 2>} : !tt.ptr<bf16>, !tt.tensordesc<128x128xbf16, #shared>
    %31 = tt.make_tensor_descriptor %arg1, [%arg5, %28], [%29, %c1_i64] {ttg.partition = array<i32: 2>} : !tt.ptr<bf16>, !tt.tensordesc<128x128xbf16, #shared>
    %32 = tt.make_tensor_descriptor %arg1, [%arg5, %28], [%29, %c1_i64] {ttg.partition = array<i32: 2>} : !tt.ptr<bf16>, !tt.tensordesc<128x128xbf16, #shared>
    %33 = tt.make_tensor_descriptor %arg3, [%arg4, %28], [%29, %c1_i64] {ttg.partition = array<i32: 2>} : !tt.ptr<bf16>, !tt.tensordesc<128x128xbf16, #shared>
    %34 = tt.make_tensor_descriptor %arg9, [%18, %28], [%29, %c1_i64] {ttg.partition = array<i32: 4>} : !tt.ptr<bf16>, !tt.tensordesc<128x128xbf16, #shared>
    %35 = tt.make_tensor_descriptor %arg9, [%18, %28], [%29, %c1_i64] {ttg.partition = array<i32: 3>} : !tt.ptr<bf16>, !tt.tensordesc<128x128xbf16, #shared>
    %36 = tt.make_tensor_descriptor %arg8, [%25, %28], [%29, %c1_i64] {ttg.partition = array<i32: 0>} : !tt.ptr<f32>, !tt.tensordesc<128x128xf32, #shared3>
    ...
    scf.for %arg35 = %c0_i32 to %19 step %c256_i32  : i32 {
      ...
      %67 = tt.descriptor_load %31[%64, %37] {ttg.partition = array<i32: 2>} : !tt.tensordesc<128x128xbf16, #shared> -> tensor<128x128xbf16, #blocked1>
      %68 = tt.descriptor_load %32[%66, %37] {ttg.partition = array<i32: 2>} : !tt.tensordesc<128x128xbf16, #shared> -> tensor<128x128xbf16, #blocked1>
      ...
      %85:9 = scf.for %arg36 = %c0_i32 to %26 step %c128_i32 iter_args(%arg37 = %false, %arg38 = %token_4, %arg39 = %token_10, %arg40 = %82, %arg41 = %token_14, %arg42 = %token_6, %arg43 = %token_12, %arg44 = %84, %arg45 = %token_16) -> (i1, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token)  : i32 {
        ...
        %100 = tt.descriptor_load %30[%99, %46] {ttg.partition = array<i32: 2>} : !tt.tensordesc<128x128xbf16, #shared> -> tensor<128x128xbf16, #blocked1>
        ...
        %116 = tt.descriptor_load %33[%99, %54] {ttg.partition = array<i32: 2>} : !tt.tensordesc<128x128xbf16, #shared> -> tensor<128x128xbf16, #blocked1>
        ...
        %173 = ttng.async_tma_reduce add, %36[%99, %58] %60 {ttg.partition = array<i32: 0>} : !tt.tensordesc<128x128xf32, #shared3>, !ttg.memdesc<128x128xf32, #shared3, #smem, mutable> -> !ttg.async.token
        ...
        %174 = ttng.async_tma_reduce add, %36[%99, %58] %61 {ttg.partition = array<i32: 0>} : !tt.tensordesc<128x128xf32, #shared3>, !ttg.memdesc<128x128xf32, #shared3, #smem, mutable> -> !ttg.async.token
      ...
      %92 = ttng.async_tma_copy_local_to_global %34[%64, %59] %62 {ttg.partition = array<i32: 4>} : !tt.tensordesc<128x128xbf16, #shared>, !ttg.memdesc<128x128xbf16, #shared, #smem, mutable> -> !ttg.async.token
      ...
      %93 = ttng.async_tma_copy_local_to_global %35[%65, %59] %63 {ttg.partition = array<i32: 3>} : !tt.tensordesc<128x128xbf16, #shared>, !ttg.memdesc<128x128xbf16, #shared, #smem, mutable> -> !ttg.async.token
