...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:90", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @matmul_ws_gather_and_descriptor_load(%arg0: !tt.tensordesc<1x64xf16, #shared>, %arg1: !tt.tensordesc<64x256xf16>, %arg2: !tt.tensordesc<128x256xf16>, %arg3: i32 {tt.divisibility = 16 : i32}, %arg4: i32 {tt.divisibility = 16 : i32}, %arg5: i32 {tt.divisibility = 16 : i32}) {
    ...
    scf.for %arg6 = %0 to %arg3 step %1  : i32 {
      %2:2 = scf.for %arg7 = %c0_i32 to %arg5 step %c1_i32 iter_args(%arg8 = %cst, %arg9 = %c0_i32) -> (tensor<128x256xf32, #mma>, i32)  : i32 {
        ...
        %6 = tt.descriptor_gather %arg0[%5, %arg9] : (!tt.tensordesc<1x64xf16, #shared>, tensor<128xi32, #indices>, i32) -> tensor<128x64xf16, #blocked>
        %7 = ttg.local_alloc %6 : (tensor<128x64xf16, #blocked>) -> !ttg.memdesc<128x64xf16, #shared, #smem>
        %8 = tt.descriptor_load %arg1[%arg9, %arg6] : !tt.tensordesc<64x256xf16> -> tensor<64x256xf16, #blocked1>
  ...
  tt.func public @matmul_ws_all_descriptor_gather(%arg0: !tt.tensordesc<1x64xf16, #shared>, %arg1: !tt.tensordesc<1x256xf16, #shared>, %arg2: !tt.tensordesc<128x256xf16>, %arg3: i32 {tt.divisibility = 16 : i32}, %arg4: i32 {tt.divisibility = 16 : i32}, %arg5: i32 {tt.divisibility = 16 : i32}) {
    %c0_i32 = arith.constant 0 : i32
    %c1_i32 = arith.constant 1 : i32
    %c64_i32 = arith.constant 64 : i32
    %cst = arith.constant dense<0.000000e+00> : tensor<128x256xf32, #mma>
    ...
    scf.for %arg6 = %0 to %arg3 step %1  : i32 {
      %2:2 = scf.for %arg7 = %c0_i32 to %arg5 step %c1_i32 iter_args(%arg8 = %cst, %arg9 = %c0_i32) -> (tensor<128x256xf32, #mma>, i32)  : i32 {
        ...
        %9 = tt.descriptor_gather %arg1[%8, %arg6] : (!tt.tensordesc<1x256xf16, #shared>, tensor<64xi32, #indices>, i32) -> tensor<64x256xf16, #blocked1>
