...
// OPERANDD: default
// OPERANDD: nvws.producer_acquire {{.*}}loc(#loc144)
// OPERANDD: ttng.tmem_store {{.*}}tmem.start{{.*}}loc(#loc144)
// OPERANDD: nvws.producer_acquire {{.*}}loc(#loc142)
// OPERANDD: ttng.tmem_store {{.*}}tmem.start{{.*}}loc(#loc142)
