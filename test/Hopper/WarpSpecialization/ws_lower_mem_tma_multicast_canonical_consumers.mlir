...
// A boundary local_load may carry a broader task annotation than its terminal
// consumer. Multicast rendezvous planning must use the channel's canonical
// terminal-consumer set rather than treating every boundary task as a consumer.

// CHECK-LABEL: @canonical_multicast_consumers
// CHECK: ttng.async_tma_copy_global_to_local
// CHECK-SAME: tt.multicast_axes = array<i32: 0>
// One producer-reuse rendezvous and one terminal-consumer ready rendezvous.
// CHECK-COUNT-2: ttng.arrive_barrier
...
module attributes {
  ...
  tt.func public @canonical_multicast_consumers(
    ...
    scf.for %iv = %i0 to %i4 step %i1 {
      ...
      %local = ttg.local_load %buffer {async_task_id = array<i32: 1, 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !ttg.memdesc<128x64xf16, #shared, #smem, mutable> -> tensor<128x64xf16, #blocked>
