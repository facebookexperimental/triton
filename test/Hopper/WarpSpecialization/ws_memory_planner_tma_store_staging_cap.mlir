...
module attributes {"ttg.cluster-dim-x" = 1 : i32, "ttg.cluster-dim-y" = 1 : i32, "ttg.cluster-dim-z" = 1 : i32, ttg.early_tma_store_lowering = true, ttg.max_reg_auto_ws = 192 : i32, ttg.min_reg_auto_ws = 24 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @_attn_bwd_persist(%desc_q: !tt.tensordesc<tensor<64x128xf16, #shared>> loc("desc_q"(#loc)), %desc_q_0: i32 loc("desc_q"(#loc)), %desc_q_1: i32 loc("desc_q"(#loc)), %desc_q_2: i64 loc("desc_q"(#loc)), %desc_q_3: i64 loc("desc_q"(#loc)), %desc_k: !tt.tensordesc<tensor<128x128xf16, #shared>> loc("desc_k"(#loc)), %desc_k_4: i32 loc("desc_k"(#loc)), %desc_k_5: i32 loc("desc_k"(#loc)), %desc_k_6: i64 loc("desc_k"(#loc)), %desc_k_7: i64 loc("desc_k"(#loc)), %desc_v: !tt.tensordesc<tensor<128x128xf16, #shared>> loc("desc_v"(#loc)), %desc_v_8: i32 loc("desc_v"(#loc)), %desc_v_9: i32 loc("desc_v"(#loc)), %desc_v_10: i64 loc("desc_v"(#loc)), %desc_v_11: i64 loc("desc_v"(#loc)), %sm_scale: f32 loc("sm_scale"(#loc)), %desc_do: !tt.tensordesc<tensor<64x128xf16, #shared>> loc("desc_do"(#loc)), %desc_do_12: i32 loc("desc_do"(#loc)), %desc_do_13: i32 loc("desc_do"(#loc)), %desc_do_14: i64 loc("desc_do"(#loc)), %desc_do_15: i64 loc("desc_do"(#loc)), %desc_dq: !tt.tensordesc<tensor<64x64xf32, #shared1>> loc("desc_dq"(#loc)), %desc_dq_16: i32 loc("desc_dq"(#loc)), %desc_dq_17: i32 loc("desc_dq"(#loc)), %desc_dq_18: i64 loc("desc_dq"(#loc)), %desc_dq_19: i64 loc("desc_dq"(#loc)), %desc_dk: !tt.tensordesc<tensor<128x64xf16, #shared>> loc("desc_dk"(#loc)), %desc_dk_20: i32 loc("desc_dk"(#loc)), %desc_dk_21: i32 loc("desc_dk"(#loc)), %desc_dk_22: i64 loc("desc_dk"(#loc)), %desc_dk_23: i64 loc("desc_dk"(#loc)), %desc_dv: !tt.tensordesc<tensor<128x64xf16, #shared>> loc("desc_dv"(#loc)), %desc_dv_24: i32 loc("desc_dv"(#loc)), %desc_dv_25: i32 loc("desc_dv"(#loc)), %desc_dv_26: i64 loc("desc_dv"(#loc)), %desc_dv_27: i64 loc("desc_dv"(#loc)), %desc_m: !tt.tensordesc<tensor<64xf32, #shared2>> loc("desc_m"(#loc)), %desc_m_28: i32 loc("desc_m"(#loc)), %desc_m_29: i64 loc("desc_m"(#loc)), %desc_delta: !tt.tensordesc<tensor<64xf32, #shared2>> loc("desc_delta"(#loc)), %desc_delta_30: i32 loc("desc_delta"(#loc)), %desc_delta_31: i64 loc("desc_delta"(#loc)), %stride_z: i32 {tt.divisibility = 16 : i32} loc("stride_z"(#loc)), %stride_h: i32 {tt.divisibility = 16 : i32} loc("stride_h"(#loc)), %stride_tok: i32 {tt.divisibility = 16 : i32} loc("stride_tok"(#loc)), %BATCH: i32 loc("BATCH"(#loc)), %H: i32 {tt.divisibility = 16 : i32} loc("H"(#loc)), %N_CTX: i32 {tt.divisibility = 16 : i32} loc("N_CTX"(#loc))) attributes {noinline = false} {
    ...
    %false = arith.constant {ttg.partition = array<i32: 1>} false loc(#loc17)
    %cst = arith.constant {ttg.partition = array<i32: 0>} dense<0.693147182> : tensor<64x64xf32, #blocked> loc(#loc17)
    %c0_i32 = arith.constant {ttg.partition = array<i32: 0, 1, 2, 3>} 0 : i32 loc(#loc17)
    %c1_i32 = arith.constant {ttg.partition = array<i32: 0, 1, 2, 3>} 1 : i32 loc(#loc17)
    %c128_i32 = arith.constant {ttg.partition = array<i32: 0, 1, 2, 3>} 128 : i32 loc(#loc17)
    %n_tile_num = arith.constant {ttg.partition = array<i32: 0, 1, 2, 3>} 127 : i32 loc(#loc159)
    %c64_i32 = arith.constant {ttg.partition = array<i32: 0, 1, 2, 3>} 64 : i32 loc(#loc17)
    %true = arith.constant {ttg.partition = array<i32: 0, 1>} true loc(#loc17)
    %cst_37 = arith.constant {ttg.partition = array<i32: 0>} dense<0.000000e+00> : tensor<128x128xf32, #linear> loc(#loc17)
    %n_tile_num_38 = arith.addi %N_CTX, %n_tile_num {ttg.partition = array<i32: 0, 1, 2, 3>} : i32 loc(#loc160)
    %n_tile_num_39 = arith.divsi %n_tile_num_38, %c128_i32 {ttg.partition = array<i32: 0, 1, 2, 3>} : i32 loc(#loc161)
    %prog_id = tt.get_program_id x {ttg.partition = array<i32: 0, 1, 2, 3>} : i32 loc(#loc109)
    %num_progs = tt.get_num_programs x {ttg.partition = array<i32: 0, 1, 2, 3>} : i32 loc(#loc110)
    %total_tiles = arith.muli %n_tile_num_39, %BATCH {ttg.partition = array<i32: 0, 1, 2, 3>} : i32 loc(#loc111)
    %total_tiles_40 = arith.muli %total_tiles, %H {ttg.partition = array<i32: 0, 1, 2, 3>} : i32 loc(#loc112)
    %tiles_per_sm = arith.divsi %total_tiles_40, %num_progs {ttg.partition = array<i32: 0, 1, 2, 3>} : i32 loc(#loc162)
    %0 = arith.remsi %total_tiles_40, %num_progs {ttg.partition = array<i32: 0, 1, 2, 3>} : i32 loc(#loc26)
    %1 = arith.cmpi slt, %prog_id, %0 {ttg.partition = array<i32: 0, 1, 2, 3>} : i32 loc(#loc27)
    %2 = scf.if %1 -> (i32) {
      %tiles_per_sm_41 = arith.addi %tiles_per_sm, %c1_i32 {ttg.partition = array<i32: 0, 1, 2, 3>} : i32 loc(#loc163)
      scf.yield {ttg.partition = array<i32: 0, 1, 2, 3>} %tiles_per_sm_41 : i32 loc(#loc163)
    } else {
      scf.yield {ttg.partition = array<i32: 0, 1, 2, 3>} %tiles_per_sm : i32 loc(#loc28)
    } {ttg.partition = array<i32: 0, 1, 2, 3>} loc(#loc28)
    %off_bh = arith.extsi %stride_tok {ttg.partition = array<i32: 0, 2, 3>} : i32 to i64 loc(#loc164)
    %num_steps = arith.divsi %N_CTX, %c64_i32 {ttg.partition = array<i32: 0, 1, 2, 3>} : i32 loc(#loc165)
    %dkN = tt.splat %sm_scale {ttg.partition = array<i32: 3>} : f32 -> tensor<128x64xf32, #linear1> loc(#loc166)
    %tile_idx = scf.for %_ = %c0_i32 to %2 step %c1_i32 iter_args(%tile_idx_41 = %prog_id) -> (i32)  : i32 {
      %pid = arith.remsi %tile_idx_41, %n_tile_num_39 {ttg.partition = array<i32: 2, 3>} : i32 loc(#loc119)
      %bhid = arith.divsi %tile_idx_41, %n_tile_num_39 {ttg.partition = array<i32: 0, 2, 3>} : i32 loc(#loc120)
      %off_chz = arith.muli %bhid, %N_CTX {ttg.partition = array<i32: 2>} : i32 loc(#loc167)
      %off_chz_42 = arith.extsi %off_chz {ttg.partition = array<i32: 2>} : i32 to i64 loc(#loc168)
      %off_bh_43 = arith.remsi %bhid, %H {ttg.partition = array<i32: 0, 2, 3>} : i32 loc(#loc169)
      %off_bh_44 = arith.muli %stride_h, %off_bh_43 {ttg.partition = array<i32: 0, 2, 3>} : i32 loc(#loc170)
      %off_bh_45 = arith.divsi %bhid, %H {ttg.partition = array<i32: 0, 2, 3>} : i32 loc(#loc171)
      %off_bh_46 = arith.muli %stride_z, %off_bh_45 {ttg.partition = array<i32: 0, 2, 3>} : i32 loc(#loc172)
      %off_bh_47 = arith.addi %off_bh_44, %off_bh_46 {ttg.partition = array<i32: 0, 2, 3>} : i32 loc(#loc173)
      %off_bh_48 = arith.extsi %off_bh_47 {ttg.partition = array<i32: 0, 2, 3>} : i32 to i64 loc(#loc174)
      %off_bh_49 = arith.divsi %off_bh_48, %off_bh {ttg.partition = array<i32: 0, 2, 3>} : i64 loc(#loc164)
      %start_n = arith.muli %pid, %c128_i32 {ttg.partition = array<i32: 2, 3>} : i32 loc(#loc175)
      %k_50 = arith.extsi %start_n {ttg.partition = array<i32: 2, 3>} : i32 to i64 loc(#loc176)
      %k_51 = arith.addi %off_bh_49, %k_50 {ttg.partition = array<i32: 2, 3>} : i64 loc(#loc176)
      %k_52 = arith.trunci %k_51 {ttg.partition = array<i32: 2, 3>} : i64 to i32 loc(#loc177)
      %k_53 = tt.descriptor_load %desc_k[%k_52, %c0_i32] {ttg.partition = array<i32: 2>} : !tt.tensordesc<tensor<128x128xf16, #shared>> -> tensor<128x128xf16, #blocked1> loc(#loc158)
      ttg.local_store %k_53, %k {ttg.partition = array<i32: 2>} : tensor<128x128xf16, #blocked1> -> !ttg.memdesc<128x128xf16, #shared, #smem, mutable> loc(#loc158)
      %v_54 = tt.descriptor_load %desc_v[%k_52, %c0_i32] {ttg.partition = array<i32: 2>} : !tt.tensordesc<tensor<128x128xf16, #shared>> -> tensor<128x128xf16, #blocked1> loc(#loc157)
      ttg.local_store %v_54, %v {ttg.partition = array<i32: 2>} : tensor<128x128xf16, #blocked1> -> !ttg.memdesc<128x128xf16, #shared, #smem, mutable> loc(#loc157)
      %curr_m:7 = scf.for %curr_m_68 = %c0_i32 to %num_steps step %c1_i32 iter_args(%arg51 = %c0_i32, %arg52 = %false, %qkT_69 = %qkT_34, %dpT_70 = %dpT_33, %dv_71 = %dv_36, %dq_72 = %dq_32, %dk_73 = %dk_35) -> (i32, i1, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token)  : i32 {
        %q_74 = arith.extsi %arg51 {ttg.partition = array<i32: 0, 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : i32 to i64 loc(#loc194)
        %q_75 = arith.addi %off_bh_49, %q_74 {ttg.partition = array<i32: 0, 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : i64 loc(#loc194)
        %q_76 = arith.trunci %q_75 {ttg.partition = array<i32: 0, 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : i64 to i32 loc(#loc195)
        %q_77 = tt.descriptor_load %desc_q[%q_76, %c0_i32] {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<tensor<64x128xf16, #shared>> -> tensor<64x128xf16, #blocked1> loc(#loc190)
        ttg.local_store %q_77, %q {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : tensor<64x128xf16, #blocked1> -> !ttg.memdesc<64x128xf16, #shared, #smem, mutable> loc(#loc190)
        %qT = ttg.memdesc_trans %q {ttg.partition = array<i32: 1>, loop.cluster = 1 : i32, loop.stage = 0 : i32, order = array<i32: 1, 0>} : !ttg.memdesc<64x128xf16, #shared, #smem, mutable> -> !ttg.memdesc<128x64xf16, #shared3, #smem, mutable> loc(#loc196)
        %offs_m_start = arith.addi %off_chz_42, %q_74 {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : i64 loc(#loc197)
        %m_78 = arith.trunci %offs_m_start {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : i64 to i32 loc(#loc198)
        %m_79 = tt.descriptor_load %desc_m[%m_78] {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<tensor<64xf32, #shared2>> -> tensor<64xf32, #blocked2> loc(#loc189)
        ttg.local_store %m_79, %m {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : tensor<64xf32, #blocked2> -> !ttg.memdesc<64xf32, #shared2, #smem, mutable> loc(#loc189)
        %qkT_80 = ttng.tc_gen5_mma %k, %qT, %qkT[%qkT_69], %false, %true {ttg.partition = array<i32: 1>, loop.cluster = 1 : i32, loop.stage = 0 : i32, tt.autows = "{\22stage\22: \220\22, \22order\22: \220\22, \22channels\22: [\22opndA,smem,1,0\22, \22opndB,smem,2,1\22, \22opndD,tmem,1,2\22]}", tt.self_latency = 1 : i32} : !ttg.memdesc<128x128xf16, #shared, #smem, mutable>, !ttg.memdesc<128x64xf16, #shared3, #smem, mutable>, !ttg.memdesc<128x64xf32, #tmem1, #ttng.tensor_memory, mutable> loc(#loc188)
        %m_81 = ttg.local_load %m {ttg.partition = array<i32: 3>, loop.cluster = 4 : i32, loop.stage = 0 : i32} : !ttg.memdesc<64xf32, #shared2, #smem, mutable> -> tensor<64xf32, #blocked2> loc(#loc189)
        %pT = ttg.convert_layout %m_81 {ttg.partition = array<i32: 3>, loop.cluster = 4 : i32, loop.stage = 0 : i32} : tensor<64xf32, #blocked2> -> tensor<64xf32, #ttg.slice<{dim = 0, parent = #linear1}>> loc(#loc199)
        %pT_82 = tt.expand_dims %pT {ttg.partition = array<i32: 3>, axis = 0 : i32, loop.cluster = 4 : i32, loop.stage = 0 : i32} : tensor<64xf32, #ttg.slice<{dim = 0, parent = #linear1}>> -> tensor<1x64xf32, #linear1> loc(#loc200)
        %pT_83 = tt.broadcast %pT_82 {ttg.partition = array<i32: 3>, loop.cluster = 4 : i32, loop.stage = 0 : i32} : tensor<1x64xf32, #linear1> -> tensor<128x64xf32, #linear1> loc(#loc199)
        %qkT_84, %qkT_85 = ttng.tmem_load %qkT[%qkT_80] {ttg.partition = array<i32: 3>, loop.cluster = 4 : i32, loop.stage = 0 : i32} : !ttg.memdesc<128x64xf32, #tmem1, #ttng.tensor_memory, mutable> -> tensor<128x64xf32, #linear1> loc(#loc188)
        %pT_86 = arith.subf %qkT_84, %pT_83 {ttg.partition = array<i32: 3>, loop.cluster = 4 : i32, loop.stage = 0 : i32} : tensor<128x64xf32, #linear1> loc(#loc199)
        %pT_87 = math.exp2 %pT_86 {ttg.partition = array<i32: 3>, loop.cluster = 4 : i32, loop.stage = 0 : i32} : tensor<128x64xf32, #linear1> loc(#loc201)
        %do_88 = tt.descriptor_load %desc_do[%q_76, %c0_i32] {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<tensor<64x128xf16, #shared>> -> tensor<64x128xf16, #blocked1> loc(#loc187)
        ttg.local_store %do_88, %do {ttg.partition = array<i32: 2>, loop.cluster = 4 : i32, loop.stage = 0 : i32} : tensor<64x128xf16, #blocked1> -> !ttg.memdesc<64x128xf16, #shared, #smem, mutable> loc(#loc187)
        %ppT_89 = arith.truncf %pT_87 {ttg.partition = array<i32: 3>, loop.cluster = 4 : i32, loop.stage = 0 : i32} : tensor<128x64xf32, #linear1> to tensor<128x64xf16, #linear1> loc(#loc186)
        %dv_90 = arith.constant {ttg.partition = array<i32: 3>, loop.cluster = 4 : i32, loop.stage = 0 : i32} true loc(#loc192)
        ttng.tmem_store %ppT_89, %ppT, %dv_90 {ttg.partition = array<i32: 3>, loop.cluster = 4 : i32, loop.stage = 0 : i32} : tensor<128x64xf16, #linear1> -> !ttg.memdesc<128x64xf16, #tmem1, #ttng.tensor_memory, mutable> loc(#loc192)
        %dpT_91 = ttg.memdesc_trans %do {ttg.partition = array<i32: 1>, loop.cluster = 4 : i32, loop.stage = 0 : i32, order = array<i32: 1, 0>} : !ttg.memdesc<64x128xf16, #shared, #smem, mutable> -> !ttg.memdesc<128x64xf16, #shared3, #smem, mutable> loc(#loc202)
        %dpT_92 = ttng.tc_gen5_mma %v, %dpT_91, %dpT[%dpT_70], %false, %true {ttg.partition = array<i32: 1>, loop.cluster = 4 : i32, loop.stage = 0 : i32, tt.autows = "{\22stage\22: \220\22, \22order\22: \222\22, \22channels\22: [\22opndA,smem,1,3\22, \22opndB,smem,1,4\22, \22opndD,tmem,1,5\22]}", tt.self_latency = 1 : i32} : !ttg.memdesc<128x128xf16, #shared, #smem, mutable>, !ttg.memdesc<128x64xf16, #shared3, #smem, mutable>, !ttg.memdesc<128x64xf32, #tmem1, #ttng.tensor_memory, mutable> loc(#loc185)
        %Di_93 = tt.descriptor_load %desc_delta[%m_78] {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<tensor<64xf32, #shared2>> -> tensor<64xf32, #blocked2> loc(#loc184)
        ttg.local_store %Di_93, %Di {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : tensor<64xf32, #blocked2> -> !ttg.memdesc<64xf32, #shared2, #smem, mutable> loc(#loc184)
        %dv_94 = ttng.tc_gen5_mma %ppT, %do, %dv[%dv_71], %arg52, %true {ttg.partition = array<i32: 1>, loop.cluster = 4 : i32, loop.stage = 0 : i32, tt.autows = "{\22stage\22: \220\22, \22order\22: \222\22, \22channels\22: [\22opndA,tmem,1,2\22, \22opndD,tmem,1,7\22]}", tt.self_latency = 1 : i32} : !ttg.memdesc<128x64xf16, #tmem1, #ttng.tensor_memory, mutable>, !ttg.memdesc<64x128xf16, #shared, #smem, mutable>, !ttg.memdesc<128x128xf32, #tmem2, #ttng.tensor_memory, mutable> loc(#loc192)
        %Di_95 = ttg.local_load %Di {ttg.partition = array<i32: 3>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : !ttg.memdesc<64xf32, #shared2, #smem, mutable> -> tensor<64xf32, #blocked2> loc(#loc184)
        %dsT_96 = ttg.convert_layout %Di_95 {ttg.partition = array<i32: 3>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<64xf32, #blocked2> -> tensor<64xf32, #ttg.slice<{dim = 0, parent = #linear1}>> loc(#loc203)
        %dsT_97 = tt.expand_dims %dsT_96 {ttg.partition = array<i32: 3>, axis = 0 : i32, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<64xf32, #ttg.slice<{dim = 0, parent = #linear1}>> -> tensor<1x64xf32, #linear1> loc(#loc204)
        %dsT_98 = tt.broadcast %dsT_97 {ttg.partition = array<i32: 3>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<1x64xf32, #linear1> -> tensor<128x64xf32, #linear1> loc(#loc203)
        %dpT_99, %dpT_100 = ttng.tmem_load %dpT[%dpT_92] {ttg.partition = array<i32: 3>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : !ttg.memdesc<128x64xf32, #tmem1, #ttng.tensor_memory, mutable> -> tensor<128x64xf32, #linear1> loc(#loc185)
        %dsT_101 = arith.subf %dpT_99, %dsT_98 {ttg.partition = array<i32: 3>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<128x64xf32, #linear1> loc(#loc203)
        %dsT_102 = arith.mulf %pT_87, %dsT_101 {ttg.partition = array<i32: 3>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<128x64xf32, #linear1> loc(#loc205)
        %dsT_103 = arith.truncf %dsT_102 {ttg.partition = array<i32: 3>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<128x64xf32, #linear1> to tensor<128x64xf16, #linear1> loc(#loc183)
        ttg.local_store %dsT_103, %dsT {ttg.partition = array<i32: 3>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<128x64xf16, #linear1> -> !ttg.memdesc<128x64xf16, #shared, #smem, mutable> loc(#loc183)
        %dq_104 = ttg.memdesc_trans %dsT {ttg.partition = array<i32: 1>, loop.cluster = 2 : i32, loop.stage = 1 : i32, order = array<i32: 1, 0>} : !ttg.memdesc<128x64xf16, #shared, #smem, mutable> -> !ttg.memdesc<64x128xf16, #shared3, #smem, mutable> loc(#loc206)
        %dq_105 = ttng.tc_gen5_mma %dq_104, %k, %dq[%dq_72], %false, %true {ttg.partition = array<i32: 1>, loop.cluster = 2 : i32, loop.stage = 1 : i32, tt.autows = "{\22stage\22: \221\22, \22order\22: \221\22, \22channels\22: [\22opndA,smem,1,8\22, \22opndD,tmem,1,11\22]}"} : !ttg.memdesc<64x128xf16, #shared3, #smem, mutable>, !ttg.memdesc<128x128xf16, #shared, #smem, mutable>, !ttg.memdesc<64x128xf32, #tmem, #ttng.tensor_memory, mutable> loc(#loc182)
        %dk_106 = ttng.tc_gen5_mma %dsT, %q, %dk[%dk_73], %arg52, %true {ttg.partition = array<i32: 1>, loop.cluster = 2 : i32, loop.stage = 1 : i32, tt.autows = "{\22stage\22: \221\22, \22order\22: \221\22, \22channels\22: [\22opndD,tmem,1,10\22]}", tt.self_latency = 1 : i32} : !ttg.memdesc<128x64xf16, #shared, #smem, mutable>, !ttg.memdesc<64x128xf16, #shared, #smem, mutable>, !ttg.memdesc<128x128xf32, #tmem2, #ttng.tensor_memory, mutable> loc(#loc191)
        %dq_107, %dq_108 = ttng.tmem_load %dq[%dq_105] {ttg.partition = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : !ttg.memdesc<64x128xf32, #tmem, #ttng.tensor_memory, mutable> -> tensor<64x128xf32, #linear2> loc(#loc182)
        %dqs = tt.reshape %dq_107 {ttg.partition = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<64x128xf32, #linear2> -> tensor<64x2x64xf32, #linear3> loc(#loc218)
        %dqs_109 = tt.trans %dqs {ttg.partition = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 1 : i32, order = array<i32: 0, 2, 1>} : tensor<64x2x64xf32, #linear3> -> tensor<64x64x2xf32, #linear4> loc(#loc219)
        %dqs_110 = ttg.convert_layout %dqs_109 {ttg.partition = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<64x64x2xf32, #linear4> -> tensor<64x64x2xf32, #blocked3> loc(#loc220)
        %dqs_111, %dqs_112 = tt.split %dqs_110 {ttg.partition = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<64x64x2xf32, #blocked3> -> tensor<64x64xf32, #blocked> loc(#loc220)
        %dqN = arith.mulf %dqs_111, %cst {ttg.partition = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<64x64xf32, #blocked> loc(#loc208)
        tt.descriptor_reduce add, %desc_dq[%q_76, %c0_i32], %dqN {ttg.partition = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : !tt.tensordesc<tensor<64x64xf32, #shared1>>, tensor<64x64xf32, #blocked> loc(#loc209)
        %dqN_113 = arith.mulf %dqs_112, %cst {ttg.partition = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : tensor<64x64xf32, #blocked> loc(#loc208)
        tt.descriptor_reduce add, %desc_dq[%q_76, %c64_i32], %dqN_113 {ttg.partition = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : !tt.tensordesc<tensor<64x64xf32, #shared1>>, tensor<64x64xf32, #blocked> loc(#loc209)
        %curr_m_114 = arith.addi %arg51, %c64_i32 {ttg.partition = array<i32: 0, 2>, loop.cluster = 0 : i32, loop.stage = 1 : i32} : i32 loc(#loc210)
        scf.yield {ttg.partition = array<i32: 0, 1, 2, 3>} %curr_m_114, %true, %qkT_85, %dpT_100, %dv_94, %dq_108, %dk_106 : i32, i1, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token loc(#loc179)
      } {ttg.partition = array<i32: 0, 1, 2, 3>, tt.scheduled_max_stage = 1 : i32} loc(#loc217)
      %dv_55, %dv_56 = ttng.tmem_load %dv[%curr_m#4] {ttg.partition = array<i32: 3>} : !ttg.memdesc<128x128xf32, #tmem2, #ttng.tensor_memory, mutable> -> tensor<128x128xf32, #linear> loc(#loc192)
      %dvs = tt.reshape %dv_55 {ttg.partition = array<i32: 3>} : tensor<128x128xf32, #linear> -> tensor<128x2x64xf32, #linear5> loc(#loc211)
      %dvs_57 = tt.trans %dvs {ttg.partition = array<i32: 3>, order = array<i32: 0, 2, 1>} : tensor<128x2x64xf32, #linear5> -> tensor<128x64x2xf32, #linear6> loc(#loc212)
      %dvs_58, %dvs_59 = tt.split %dvs_57 {ttg.partition = array<i32: 3>} : tensor<128x64x2xf32, #linear6> -> tensor<128x64xf32, #linear1> loc(#loc213)
      %3 = arith.truncf %dvs_58 {ttg.partition = array<i32: 3>} : tensor<128x64xf32, #linear1> to tensor<128x64xf16, #linear1> loc(#loc150)
      %4 = ttg.convert_layout %3 {ttg.partition = array<i32: 3>} : tensor<128x64xf16, #linear1> -> tensor<128x64xf16, #blocked4> loc(#loc150)
      %5 = ttg.local_alloc : () -> !ttg.memdesc<128x64xf16, #shared, #smem, mutable> loc(#loc151)
      ttg.local_store %4, %5 {ttg.partition = array<i32: 3>} : tensor<128x64xf16, #blocked4> -> !ttg.memdesc<128x64xf16, #shared, #smem, mutable> loc(#loc151)
      %6 = ttng.async_tma_copy_local_to_global %desc_dv[%k_52, %c0_i32] %5 {ttg.partition = array<i32: 3>} : !tt.tensordesc<tensor<128x64xf16, #shared>>, !ttg.memdesc<128x64xf16, #shared, #smem, mutable> -> !ttg.async.token loc(#loc151)
      ttng.async_tma_store_token_wait %6   {ttg.partition = array<i32: 3>} : !ttg.async.token loc(#loc151)
      %7 = arith.truncf %dvs_59 {ttg.partition = array<i32: 3>} : tensor<128x64xf32, #linear1> to tensor<128x64xf16, #linear1> loc(#loc150)
      %8 = ttg.convert_layout %7 {ttg.partition = array<i32: 3>} : tensor<128x64xf16, #linear1> -> tensor<128x64xf16, #blocked4> loc(#loc150)
      %9 = ttg.local_alloc : () -> !ttg.memdesc<128x64xf16, #shared, #smem, mutable> loc(#loc151)
      ttg.local_store %8, %9 {ttg.partition = array<i32: 3>} : tensor<128x64xf16, #blocked4> -> !ttg.memdesc<128x64xf16, #shared, #smem, mutable> loc(#loc151)
      %10 = ttng.async_tma_copy_local_to_global %desc_dv[%k_52, %c64_i32] %9 {ttg.partition = array<i32: 3>} : !tt.tensordesc<tensor<128x64xf16, #shared>>, !ttg.memdesc<128x64xf16, #shared, #smem, mutable> -> !ttg.async.token loc(#loc151)
      ttng.async_tma_store_token_wait %10   {ttg.partition = array<i32: 3>} : !ttg.async.token loc(#loc151)
      %dk_60, %dk_61 = ttng.tmem_load %dk[%curr_m#6] {ttg.partition = array<i32: 3>} : !ttg.memdesc<128x128xf32, #tmem2, #ttng.tensor_memory, mutable> -> tensor<128x128xf32, #linear> loc(#loc191)
      %dks = tt.reshape %dk_60 {ttg.partition = array<i32: 3>} : tensor<128x128xf32, #linear> -> tensor<128x2x64xf32, #linear5> loc(#loc214)
      %dks_62 = tt.trans %dks {ttg.partition = array<i32: 3>, order = array<i32: 0, 2, 1>} : tensor<128x2x64xf32, #linear5> -> tensor<128x64x2xf32, #linear6> loc(#loc215)
      %dks_63, %dks_64 = tt.split %dks_62 {ttg.partition = array<i32: 3>} : tensor<128x64x2xf32, #linear6> -> tensor<128x64xf32, #linear1> loc(#loc216)
      %dkN_65 = arith.mulf %dks_63, %dkN {ttg.partition = array<i32: 3>} : tensor<128x64xf32, #linear1> loc(#loc166)
      %11 = arith.truncf %dkN_65 {ttg.partition = array<i32: 3>} : tensor<128x64xf32, #linear1> to tensor<128x64xf16, #linear1> loc(#loc153)
      %12 = ttg.convert_layout %11 {ttg.partition = array<i32: 3>} : tensor<128x64xf16, #linear1> -> tensor<128x64xf16, #blocked4> loc(#loc153)
      %13 = ttg.local_alloc : () -> !ttg.memdesc<128x64xf16, #shared, #smem, mutable> loc(#loc154)
      ttg.local_store %12, %13 {ttg.partition = array<i32: 3>} : tensor<128x64xf16, #blocked4> -> !ttg.memdesc<128x64xf16, #shared, #smem, mutable> loc(#loc154)
      %14 = ttng.async_tma_copy_local_to_global %desc_dk[%k_52, %c0_i32] %13 {ttg.partition = array<i32: 3>} : !tt.tensordesc<tensor<128x64xf16, #shared>>, !ttg.memdesc<128x64xf16, #shared, #smem, mutable> -> !ttg.async.token loc(#loc154)
      ttng.async_tma_store_token_wait %14   {ttg.partition = array<i32: 3>} : !ttg.async.token loc(#loc154)
      %dkN_66 = arith.mulf %dks_64, %dkN {ttg.partition = array<i32: 3>} : tensor<128x64xf32, #linear1> loc(#loc166)
      %15 = arith.truncf %dkN_66 {ttg.partition = array<i32: 3>} : tensor<128x64xf32, #linear1> to tensor<128x64xf16, #linear1> loc(#loc153)
      %16 = ttg.convert_layout %15 {ttg.partition = array<i32: 3>} : tensor<128x64xf16, #linear1> -> tensor<128x64xf16, #blocked4> loc(#loc153)
      %17 = ttg.local_alloc : () -> !ttg.memdesc<128x64xf16, #shared, #smem, mutable> loc(#loc154)
      ttg.local_store %16, %17 {ttg.partition = array<i32: 3>} : tensor<128x64xf16, #blocked4> -> !ttg.memdesc<128x64xf16, #shared, #smem, mutable> loc(#loc154)
      %18 = ttng.async_tma_copy_local_to_global %desc_dk[%k_52, %c64_i32] %17 {ttg.partition = array<i32: 3>} : !tt.tensordesc<tensor<128x64xf16, #shared>>, !ttg.memdesc<128x64xf16, #shared, #smem, mutable> -> !ttg.async.token loc(#loc154)
      ttng.async_tma_store_token_wait %18   {ttg.partition = array<i32: 3>} : !ttg.async.token loc(#loc154)
      %tile_idx_67 = arith.addi %tile_idx_41, %num_progs {ttg.partition = array<i32: 0, 2, 3>} : i32 loc(#loc155)
      scf.yield {ttg.partition = array<i32: 0, 2, 3>} %tile_idx_67 : i32 loc(#loc76)
