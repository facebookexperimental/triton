...
module attributes {"ttg.cluster-dim-x" = 1 : i32, "ttg.cluster-dim-y" = 1 : i32, "ttg.cluster-dim-z" = 1 : i32, ttg.early_tma_store_lowering = true, ttg.max_reg_auto_ws = 192 : i32, ttg.min_reg_auto_ws = 24 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @_attn_bwd_persist(%desc_q: !tt.tensordesc<64x128xf16, #shared> loc("desc_q"(#loc)), %desc_q_0: i32 loc("desc_q"(#loc)), %desc_q_1: i32 loc("desc_q"(#loc)), %desc_q_2: i64 loc("desc_q"(#loc)), %desc_q_3: i64 loc("desc_q"(#loc)), %desc_k: !tt.tensordesc<128x128xf16, #shared> loc("desc_k"(#loc)), %desc_k_4: i32 loc("desc_k"(#loc)), %desc_k_5: i32 loc("desc_k"(#loc)), %desc_k_6: i64 loc("desc_k"(#loc)), %desc_k_7: i64 loc("desc_k"(#loc)), %desc_v: !tt.tensordesc<128x128xf16, #shared> loc("desc_v"(#loc)), %desc_v_8: i32 loc("desc_v"(#loc)), %desc_v_9: i32 loc("desc_v"(#loc)), %desc_v_10: i64 loc("desc_v"(#loc)), %desc_v_11: i64 loc("desc_v"(#loc)), %sm_scale: f32 loc("sm_scale"(#loc)), %desc_do: !tt.tensordesc<64x128xf16, #shared> loc("desc_do"(#loc)), %desc_do_12: i32 loc("desc_do"(#loc)), %desc_do_13: i32 loc("desc_do"(#loc)), %desc_do_14: i64 loc("desc_do"(#loc)), %desc_do_15: i64 loc("desc_do"(#loc)), %desc_dq: !tt.tensordesc<64x64xf32, #shared1> loc("desc_dq"(#loc)), %desc_dq_16: i32 loc("desc_dq"(#loc)), %desc_dq_17: i32 loc("desc_dq"(#loc)), %desc_dq_18: i64 loc("desc_dq"(#loc)), %desc_dq_19: i64 loc("desc_dq"(#loc)), %desc_dk: !tt.tensordesc<128x64xf16, #shared> loc("desc_dk"(#loc)), %desc_dk_20: i32 loc("desc_dk"(#loc)), %desc_dk_21: i32 loc("desc_dk"(#loc)), %desc_dk_22: i64 loc("desc_dk"(#loc)), %desc_dk_23: i64 loc("desc_dk"(#loc)), %desc_dv: !tt.tensordesc<128x64xf16, #shared> loc("desc_dv"(#loc)), %desc_dv_24: i32 loc("desc_dv"(#loc)), %desc_dv_25: i32 loc("desc_dv"(#loc)), %desc_dv_26: i64 loc("desc_dv"(#loc)), %desc_dv_27: i64 loc("desc_dv"(#loc)), %desc_m: !tt.tensordesc<64xf32, #shared2> loc("desc_m"(#loc)), %desc_m_28: i32 loc("desc_m"(#loc)), %desc_m_29: i64 loc("desc_m"(#loc)), %desc_delta: !tt.tensordesc<64xf32, #shared2> loc("desc_delta"(#loc)), %desc_delta_30: i32 loc("desc_delta"(#loc)), %desc_delta_31: i64 loc("desc_delta"(#loc)), %stride_z: i32 {tt.divisibility = 16 : i32} loc("stride_z"(#loc)), %stride_h: i32 {tt.divisibility = 16 : i32} loc("stride_h"(#loc)), %stride_tok: i32 {tt.divisibility = 16 : i32} loc("stride_tok"(#loc)), %BATCH: i32 loc("BATCH"(#loc)), %H: i32 {tt.divisibility = 16 : i32} loc("H"(#loc)), %N_CTX: i32 {tt.divisibility = 16 : i32} loc("N_CTX"(#loc))) attributes {noinline = false} {
    ...
    %tile_idx = scf.for %_ = %c0_i32 to %2 step %c1_i32 iter_args(%tile_idx_41 = %prog_id) -> (i32)  : i32 {
      ...
      %k_53 = tt.descriptor_load %desc_k[%k_52, %c0_i32] {ttg.partition = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked1> loc(#loc158)
      ...
      %v_54 = tt.descriptor_load %desc_v[%k_52, %c0_i32] {ttg.partition = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked1> loc(#loc157)
      ...
      %curr_m:7 = scf.for %curr_m_68 = %c0_i32 to %num_steps step %c1_i32 iter_args(%arg51 = %c0_i32, %arg52 = %false, %qkT_69 = %qkT_34, %dpT_70 = %dpT_33, %dv_71 = %dv_36, %dq_72 = %dq_32, %dk_73 = %dk_35) -> (i32, i1, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token)  : i32 {
        ...
        %q_77 = tt.descriptor_load %desc_q[%q_76, %c0_i32] {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<64x128xf16, #shared> -> tensor<64x128xf16, #blocked1> loc(#loc190)
        ...
        %m_79 = tt.descriptor_load %desc_m[%m_78] {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<64xf32, #shared2> -> tensor<64xf32, #blocked2> loc(#loc189)
        ...
        %do_88 = tt.descriptor_load %desc_do[%q_76, %c0_i32] {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<64x128xf16, #shared> -> tensor<64x128xf16, #blocked1> loc(#loc187)
        ...
        %Di_93 = tt.descriptor_load %desc_delta[%m_78] {ttg.partition = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<64xf32, #shared2> -> tensor<64xf32, #blocked2> loc(#loc184)
        ...
        tt.descriptor_reduce add, %desc_dq[%q_76, %c0_i32], %dqN {ttg.partition = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : !tt.tensordesc<64x64xf32, #shared1>, tensor<64x64xf32, #blocked> loc(#loc209)
        ...
        tt.descriptor_reduce add, %desc_dq[%q_76, %c64_i32], %dqN_113 {ttg.partition = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 1 : i32} : !tt.tensordesc<64x64xf32, #shared1>, tensor<64x64xf32, #blocked> loc(#loc209)
      ...
      %6 = ttng.async_tma_copy_local_to_global %desc_dv[%k_52, %c0_i32] %5 {ttg.partition = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, !ttg.memdesc<128x64xf16, #shared, #smem, mutable> -> !ttg.async.token loc(#loc151)
      ...
      %10 = ttng.async_tma_copy_local_to_global %desc_dv[%k_52, %c64_i32] %9 {ttg.partition = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, !ttg.memdesc<128x64xf16, #shared, #smem, mutable> -> !ttg.async.token loc(#loc151)
      ...
      %14 = ttng.async_tma_copy_local_to_global %desc_dk[%k_52, %c0_i32] %13 {ttg.partition = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, !ttg.memdesc<128x64xf16, #shared, #smem, mutable> -> !ttg.async.token loc(#loc154)
      ...
      %18 = ttng.async_tma_copy_local_to_global %desc_dk[%k_52, %c64_i32] %17 {ttg.partition = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, !ttg.memdesc<128x64xf16, #shared, #smem, mutable> -> !ttg.async.token loc(#loc154)
