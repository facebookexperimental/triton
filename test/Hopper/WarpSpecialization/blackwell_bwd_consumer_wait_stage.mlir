  ...
  tt.func public @_attn_bwd_persist(%desc_q: !tt.tensordesc<128x128xf16, #shared> loc("desc_q"(#loc)), %desc_q_0: i32 loc("desc_q"(#loc)), %desc_q_1: i32 loc("desc_q"(#loc)), %desc_q_2: i64 loc("desc_q"(#loc)), %desc_q_3: i64 loc("desc_q"(#loc)), %desc_k: !tt.tensordesc<128x128xf16, #shared> loc("desc_k"(#loc)), %desc_k_4: i32 loc("desc_k"(#loc)), %desc_k_5: i32 loc("desc_k"(#loc)), %desc_k_6: i64 loc("desc_k"(#loc)), %desc_k_7: i64 loc("desc_k"(#loc)), %desc_v: !tt.tensordesc<128x128xf16, #shared> loc("desc_v"(#loc)), %desc_v_8: i32 loc("desc_v"(#loc)), %desc_v_9: i32 loc("desc_v"(#loc)), %desc_v_10: i64 loc("desc_v"(#loc)), %desc_v_11: i64 loc("desc_v"(#loc)), %sm_scale: f32 loc("sm_scale"(#loc)), %desc_do: !tt.tensordesc<128x128xf16, #shared> loc("desc_do"(#loc)), %desc_do_12: i32 loc("desc_do"(#loc)), %desc_do_13: i32 loc("desc_do"(#loc)), %desc_do_14: i64 loc("desc_do"(#loc)), %desc_do_15: i64 loc("desc_do"(#loc)), %desc_dq: !tt.tensordesc<128x32xf32, #shared1> loc("desc_dq"(#loc)), %desc_dq_16: i32 loc("desc_dq"(#loc)), %desc_dq_17: i32 loc("desc_dq"(#loc)), %desc_dq_18: i64 loc("desc_dq"(#loc)), %desc_dq_19: i64 loc("desc_dq"(#loc)), %desc_dk: !tt.tensordesc<128x32xf16, #shared2> loc("desc_dk"(#loc)), %desc_dk_20: i32 loc("desc_dk"(#loc)), %desc_dk_21: i32 loc("desc_dk"(#loc)), %desc_dk_22: i64 loc("desc_dk"(#loc)), %desc_dk_23: i64 loc("desc_dk"(#loc)), %desc_dv: !tt.tensordesc<128x32xf16, #shared2> loc("desc_dv"(#loc)), %desc_dv_24: i32 loc("desc_dv"(#loc)), %desc_dv_25: i32 loc("desc_dv"(#loc)), %desc_dv_26: i64 loc("desc_dv"(#loc)), %desc_dv_27: i64 loc("desc_dv"(#loc)), %M: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("M"(#loc)), %D: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("D"(#loc)), %stride_z: i32 {tt.divisibility = 16 : i32} loc("stride_z"(#loc)), %stride_h: i32 {tt.divisibility = 16 : i32} loc("stride_h"(#loc)), %stride_tok: i32 {tt.divisibility = 16 : i32} loc("stride_tok"(#loc)), %BATCH: i32 loc("BATCH"(#loc)), %H: i32 {tt.divisibility = 16 : i32} loc("H"(#loc)), %N_CTX: i32 {tt.divisibility = 16 : i32} loc("N_CTX"(#loc))) attributes {noinline = false} {
    ...
    %tile_idx = scf.for %_ = %c0_i32 to %2 step %c1_i32 iter_args(%tile_idx_37 = %prog_id) -> (i32)  : i32 {
      ...
      %curr_m:7 = scf.for %curr_m_86 = %c0_i32 to %num_steps step %c1_i32 iter_args(%arg47 = %c0_i32, %arg48 = %false, %qkT_87 = %qkT_30, %dpT_88 = %dpT_29, %dv_89 = %dv_54, %dq_90 = %dq_28, %dk_91 = %dk_53) -> (i32, i1, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token)  : i32 {
        ...
        %q_95 = tt.descriptor_load %desc_q[%q_94, %c0_i32] {async_task_id = array<i32: 2>, loop.cluster = 0 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked3> loc(#loc199)
        ...
        %do_107 = tt.descriptor_load %desc_do[%q_94, %c0_i32] {async_task_id = array<i32: 2>, loop.cluster = 0 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked3> loc(#loc197)
        ...
        tt.descriptor_reduce add, %desc_dq[%q_94, %c0_i32], %dqN_139 {async_task_id = array<i32: 0>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x32xf32, #shared1>, tensor<128x32xf32, #blocked9> loc(#loc222)
        ...
        tt.descriptor_reduce add, %desc_dq[%q_94, %c32_i32], %dqN_141 {async_task_id = array<i32: 0>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x32xf32, #shared1>, tensor<128x32xf32, #blocked9> loc(#loc222)
        ...
        tt.descriptor_reduce add, %desc_dq[%q_94, %c64_i32], %dqN_143 {async_task_id = array<i32: 0>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x32xf32, #shared1>, tensor<128x32xf32, #blocked9> loc(#loc222)
        ...
        tt.descriptor_reduce add, %desc_dq[%q_94, %c96_i32], %dqN_145 {async_task_id = array<i32: 0>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x32xf32, #shared1>, tensor<128x32xf32, #blocked9> loc(#loc222)
