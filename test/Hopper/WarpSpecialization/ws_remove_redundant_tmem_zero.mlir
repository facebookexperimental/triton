...
module attributes {"ttg.cluster-dim-x" = 1 : i32, "ttg.cluster-dim-y" = 1 : i32, "ttg.cluster-dim-z" = 1 : i32, ttg.max_reg_auto_ws = 192 : i32, ttg.min_reg_auto_ws = 24 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @_attn_bwd_persist(%desc_q: !tt.tensordesc<64x128xf16, #shared>, %desc_q_0: i32, %desc_q_1: i32, %desc_q_2: i64, %desc_q_3: i64, %desc_k: !tt.tensordesc<128x128xf16, #shared>, %desc_k_4: i32, %desc_k_5: i32, %desc_k_6: i64, %desc_k_7: i64, %desc_v: !tt.tensordesc<128x128xf16, #shared>, %desc_v_8: i32, %desc_v_9: i32, %desc_v_10: i64, %desc_v_11: i64, %sm_scale: f32, %desc_do: !tt.tensordesc<64x128xf16, #shared>, %desc_do_12: i32, %desc_do_13: i32, %desc_do_14: i64, %desc_do_15: i64, %desc_dq: !tt.tensordesc<64x64xf32, #shared1>, %desc_dq_16: i32, %desc_dq_17: i32, %desc_dq_18: i64, %desc_dq_19: i64, %desc_dk: !tt.tensordesc<128x64xf16, #shared>, %desc_dk_20: i32, %desc_dk_21: i32, %desc_dk_22: i64, %desc_dk_23: i64, %desc_dv: !tt.tensordesc<128x64xf16, #shared>, %desc_dv_24: i32, %desc_dv_25: i32, %desc_dv_26: i64, %desc_dv_27: i64, %M: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %D: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %stride_z: i32 {tt.divisibility = 16 : i32}, %stride_h: i32 {tt.divisibility = 16 : i32}, %stride_tok: i32 {tt.divisibility = 16 : i32}, %BATCH: i32, %H: i32 {tt.divisibility = 16 : i32}, %N_CTX: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %tile_idx = scf.for %_ = %c0_i32 to %2 step %c1_i32 iter_args(%tile_idx_32 = %prog_id) -> (i32)  : i32 {
      ...
      %k_45 = tt.descriptor_load %desc_k[%k_44, %c0_i32] {ttg.partition = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked3>
      %k_46 = ttg.local_alloc %k_45 {ttg.partition = array<i32: 2>} : (tensor<128x128xf16, #blocked3>) -> !ttg.memdesc<128x128xf16, #shared, #smem>
      %v = tt.descriptor_load %desc_v[%k_44, %c0_i32] {ttg.partition = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked3>
      ...
      %curr_m:7 = scf.for %curr_m_68 = %c0_i32 to %num_steps step %c1_i32 iter_args(%arg47 = %c0_i32, %arg48 = %false, %qkT_69 = %qkT_48, %dpT_70 = %dpT_49, %dv_71 = %dv_54, %dq_72 = %dq_51, %dk_73 = %dk_53) -> (i32, i1, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token)  : i32 {
        ...
        %q_76 = tt.descriptor_load %desc_q[%q_75, %c0_i32] {loop.cluster = 1 : i32, loop.stage = 0 : i32, ttg.partition = array<i32: 2>} : !tt.tensordesc<64x128xf16, #shared> -> tensor<64x128xf16, #blocked3>
        ...
        %do = tt.descriptor_load %desc_do[%q_75, %c0_i32] {loop.cluster = 1 : i32, loop.stage = 0 : i32, ttg.partition = array<i32: 2>} : !tt.tensordesc<64x128xf16, #shared> -> tensor<64x128xf16, #blocked3>
        ...
        tt.descriptor_reduce add, %desc_dq[%q_75, %c0_i32], %dqN {loop.cluster = 2 : i32, loop.stage = 1 : i32, ttg.partition = array<i32: 0>} : !tt.tensordesc<64x64xf32, #shared1>, tensor<64x64xf32, #blocked>
        %dqN_111 = arith.mulf %dqs_110, %cst {loop.cluster = 2 : i32, loop.stage = 1 : i32, ttg.partition = array<i32: 0>} : tensor<64x64xf32, #blocked>
        tt.descriptor_reduce add, %desc_dq[%q_75, %c64_i32], %dqN_111 {loop.cluster = 2 : i32, loop.stage = 1 : i32, ttg.partition = array<i32: 0>} : !tt.tensordesc<64x64xf32, #shared1>, tensor<64x64xf32, #blocked>
      ...
      tt.descriptor_store %desc_dv[%k_44, %c0_i32], %4 {ttg.partition = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, tensor<128x64xf16, #blocked10>
      ...
      tt.descriptor_store %desc_dv[%k_44, %c64_i32], %6 {ttg.partition = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, tensor<128x64xf16, #blocked10>
      ...
      tt.descriptor_store %desc_dk[%k_44, %c0_i32], %8 {ttg.partition = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, tensor<128x64xf16, #blocked10>
      ...
      tt.descriptor_store %desc_dk[%k_44, %c64_i32], %10 {ttg.partition = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, tensor<128x64xf16, #blocked10>
