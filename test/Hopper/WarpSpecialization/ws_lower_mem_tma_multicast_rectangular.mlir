...
// A rectangular 2x4 cluster still uses full-cluster rendezvous for reuse and
// readiness even though the TMA recipient group spans only one physical axis.

// CHECK-LABEL: @tma_multicast_rectangular
// CHECK-NOT: ttng.cluster_barrier
// CHECK: ttng.arrive_barrier %[[REUSE:.*]], 1
// CHECK-SAME: ctaMask = 7 : i32
...
module attributes {
  ...
  tt.func public @tma_multicast_rectangular(
