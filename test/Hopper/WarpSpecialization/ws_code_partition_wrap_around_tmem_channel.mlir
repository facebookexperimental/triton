  ...
  tt.func public @matmul_kernel_tma_persistent(%a_desc: !tt.tensordesc<128x64xf16, #shared>, %a_desc_0: i32, %a_desc_1: i32, %a_desc_2: i64, %a_desc_3: i64, %b_desc: !tt.tensordesc<64x256xf16, #shared>, %b_desc_4: i32, %b_desc_5: i32, %b_desc_6: i64, %b_desc_7: i64, %c_desc_or_ptr: !tt.tensordesc<128x64xf16, #shared>, %c_desc_or_ptr_8: i32, %c_desc_or_ptr_9: i32, %c_desc_or_ptr_10: i64, %c_desc_or_ptr_11: i64, %M: i32 {tt.divisibility = 16 : i32}, %N: i32 {tt.divisibility = 16 : i32}, %K: i32 {tt.divisibility = 16 : i32}, %stride_cm: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %tile_id_c_19 = scf.for %tile_id = %start_pid to %num_tiles step %c148_i32 iter_args(%tile_id_c_20 = %tile_id_c) -> (i32)  : i32 {
      ...
      %accumulator_25:2 = scf.for %accumulator_56 = %c0_i32 to %k_tiles_18 step %c1_i32 iter_args(%arg22 = %false, %accumulator_57 = %accumulator_24) -> (i1, !ttg.async.token)  : i32 {
        ...
        %a_58 = tt.descriptor_load %a_desc[%offs_am, %offs_k] {async_task_id = array<i32: 2>, loop.cluster = 3 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x64xf16, #shared> -> tensor<128x64xf16, #blocked1>
        ...
        %b_59 = tt.descriptor_load %b_desc[%offs_k, %offs_bn] {async_task_id = array<i32: 2>, loop.cluster = 3 : i32, loop.stage = 0 : i32} : !tt.tensordesc<64x256xf16, #shared> -> tensor<64x256xf16, #blocked2>
      ...
      tt.descriptor_store %c_desc_or_ptr[%offs_am_c, %offs_bn_c], %c0_49 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, tensor<128x64xf16, #blocked1>
      ...
      tt.descriptor_store %c_desc_or_ptr[%offs_am_c, %0], %c1_51 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, tensor<128x64xf16, #blocked1>
      ...
      tt.descriptor_store %c_desc_or_ptr[%offs_am_c, %1], %c2_53 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, tensor<128x64xf16, #blocked1>
      ...
      tt.descriptor_store %c_desc_or_ptr[%offs_am_c, %2], %c3_55 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x64xf16, #shared>, tensor<128x64xf16, #blocked1>
