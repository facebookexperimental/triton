...
//
// CHECK: ttng.tc_gen5_mma {{.*}}loop.cluster = 2{{.*}}loop.stage = 1{{.*}}loc(#loc176)
// CHECK-NOT: nvws.producer_acquire {{.*}}loc(#loc177)
// CHECK: nvws.consumer_wait {{.*}}loop.cluster = 4{{.*}}loop.stage = 1{{.*}}loc(#loc177)
// CHECK: ttng.tc_gen5_mma {{.*}}loop.cluster = 4{{.*}}loop.stage = 1{{.*}}tmem.start = array<i32: 17, 17>{{.*}}loc(#loc177)
//
// Same check for cluster 1, stage 2:
// CHECK-NOT: nvws.producer_acquire {{.*}}loc(#loc177)
// CHECK: nvws.consumer_wait {{.*}}loop.cluster = 1{{.*}}loop.stage = 2{{.*}}loc(#loc177)
// CHECK: ttng.tc_gen5_mma {{.*}}loop.cluster = 1{{.*}}loop.stage = 2{{.*}}tmem.start = array<i32: 15, 15>{{.*}}loc(#loc177)
//
