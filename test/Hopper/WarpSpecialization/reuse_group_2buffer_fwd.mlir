...
module attributes {"ttg.cluster-dim-x" = 1 : i32, "ttg.cluster-dim-y" = 1 : i32, "ttg.cluster-dim-z" = 1 : i32, ttg.max_reg_auto_ws = 152 : i32, ttg.maxnreg = 128 : i32, ttg.min_reg_auto_ws = 24 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @_attn_fwd_persist(%sm_scale: f32, %M: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %Z: i32, %H: i32 {tt.divisibility = 16 : i32}, %desc_q: !tt.ptr<f16> {tt.divisibility = 16 : i32}, %desc_k: !tt.ptr<f16> {tt.divisibility = 16 : i32}, %desc_v: !tt.ptr<f16> {tt.divisibility = 16 : i32}, %desc_o: !tt.ptr<f16> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %desc_q_25 = tt.make_tensor_descriptor %desc_q, [%desc_q_24, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 2>} : !tt.ptr<f16>, !tt.tensordesc<128x128xf16, #shared>
    %desc_q_26 = tt.make_tensor_descriptor %desc_q, [%desc_q_24, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 2>} : !tt.ptr<f16>, !tt.tensordesc<128x128xf16, #shared>
    %desc_k_27 = tt.make_tensor_descriptor %desc_k, [%desc_q_24, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 2>} : !tt.ptr<f16>, !tt.tensordesc<128x128xf16, #shared>
    %desc_v_28 = tt.make_tensor_descriptor %desc_v, [%desc_q_24, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 2>} : !tt.ptr<f16>, !tt.tensordesc<128x128xf16, #shared>
    %desc_o_29 = tt.make_tensor_descriptor %desc_o, [%desc_q_24, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 3>} : !tt.ptr<f16>, !tt.tensordesc<128x128xf16, #shared>
    %desc_o_30 = tt.make_tensor_descriptor %desc_o, [%desc_q_24, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 3>} : !tt.ptr<f16>, !tt.tensordesc<128x128xf16, #shared>
    ...
    %tile_idx = scf.for %_ = %c0_i32 to %4 step %c1_i32 iter_args(%tile_idx_35 = %prog_id) -> (i32)  : i32 {
      ...
      %q0_45 = tt.descriptor_load %desc_q_25[%qo_offset_y_39, %c0_i32] {async_task_id = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked2>
      %q0_46 = tt.descriptor_load %desc_q_26[%q0_40, %c0_i32] {async_task_id = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked2>
      ...
      %offsetkv_y_49:10 = scf.for %offsetkv_y_96 = %c0_i32 to %c1024_i32 step %c128_i32 iter_args(%offset_y_97 = %offset_y_38, %arg12 = %false, %arg13 = %cst_21, %arg14 = %cst_20, %qk_98 = %qk_6, %acc_99 = %acc_47, %arg17 = %cst_21, %arg18 = %cst_20, %qk_100 = %qk_4, %acc_101 = %acc_48) -> (i32, i1, tensor<128xf32, #ttg.slice<{dim = 1, parent = #blocked}>>, tensor<128xf32, #ttg.slice<{dim = 1, parent = #blocked}>>, !ttg.async.token, !ttg.async.token, tensor<128xf32, #ttg.slice<{dim = 1, parent = #blocked}>>, tensor<128xf32, #ttg.slice<{dim = 1, parent = #blocked}>>, !ttg.async.token, !ttg.async.token)  : i32 {
        %k_102 = tt.descriptor_load %desc_k_27[%offset_y_97, %c0_i32] {async_task_id = array<i32: 2>, loop.cluster = 6 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked2>
        ...
        %v_104 = tt.descriptor_load %desc_v_28[%offset_y_97, %c0_i32] {async_task_id = array<i32: 2>, loop.cluster = 6 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked2>
      ...
      tt.descriptor_store %desc_o_29[%qo_offset_y_39, %c0_i32], %9 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x128xf16, #shared>, tensor<128x128xf16, #blocked2>
      ...
      tt.descriptor_store %desc_o_30[%5, %c0_i32], %13 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x128xf16, #shared>, tensor<128x128xf16, #blocked2>
