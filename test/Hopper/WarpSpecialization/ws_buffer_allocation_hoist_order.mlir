...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @hoist_preserves_producer_order(
    ...
    %a = tt.descriptor_load %a_desc[%c0, %c0] {ttg.partition = array<i32: 1>} : !tt.tensordesc<tensor<128x64xf16, #shared_a>> -> tensor<128x64xf16, #blocked_a>
    %b = tt.descriptor_load %b_desc[%c0, %c0] {ttg.partition = array<i32: 1>} : !tt.tensordesc<tensor<64x128xf16, #shared_b>> -> tensor<64x128xf16, #blocked_b>
    %a_use = arith.addf %a, %a {ttg.partition = array<i32: 0>} : tensor<128x64xf16, #blocked_a>
    %b_use = arith.addf %b, %b {ttg.partition = array<i32: 0>} : tensor<64x128xf16, #blocked_b>
    tt.return
  }
}
