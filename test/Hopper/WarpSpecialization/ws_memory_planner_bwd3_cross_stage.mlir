...
module attributes {"ttg.cluster-dim-x" = 1 : i32, "ttg.cluster-dim-y" = 1 : i32, "ttg.cluster-dim-z" = 1 : i32, ttg.max_reg_auto_ws = 152 : i32, ttg.min_reg_auto_ws = 24 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @_attn_bwd_persist(%desc_q: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("desc_q"(#loc)), %desc_k: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("desc_k"(#loc)), %desc_v: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("desc_v"(#loc)), %sm_scale: f32 loc("sm_scale"(#loc)), %desc_do: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("desc_do"(#loc)), %desc_dq: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("desc_dq"(#loc)), %desc_dk: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("desc_dk"(#loc)), %desc_dv: !tt.ptr<f16> {tt.divisibility = 16 : i32} loc("desc_dv"(#loc)), %M: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("M"(#loc)), %D: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("D"(#loc)), %stride_z: i32 {tt.divisibility = 16 : i32} loc("stride_z"(#loc)), %stride_h: i32 {tt.divisibility = 16 : i32} loc("stride_h"(#loc)), %stride_tok: i32 {tt.divisibility = 16 : i32} loc("stride_tok"(#loc)), %BATCH: i32 loc("BATCH"(#loc)), %H: i32 {tt.divisibility = 16 : i32} loc("H"(#loc)), %N_CTX: i32 {tt.divisibility = 16 : i32} loc("N_CTX"(#loc))) attributes {noinline = false} {
    ...
    %desc_q_10 = tt.make_tensor_descriptor %desc_q, [%y_dim_9, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 2>} : !tt.ptr<f16>, !tt.tensordesc<128x128xf16, #shared> loc(#loc130)
    %desc_do_11 = tt.make_tensor_descriptor %desc_do, [%y_dim_9, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 2>} : !tt.ptr<f16>, !tt.tensordesc<128x128xf16, #shared> loc(#loc131)
    %desc_dq_12 = tt.make_tensor_descriptor %desc_dq, [%y_dim_9, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 0>} : !tt.ptr<f32>, !tt.tensordesc<128x32xf32, #shared1> loc(#loc132)
    %desc_v_13 = tt.make_tensor_descriptor %desc_v, [%y_dim_9, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 2>} : !tt.ptr<f16>, !tt.tensordesc<128x128xf16, #shared> loc(#loc133)
    %desc_k_14 = tt.make_tensor_descriptor %desc_k, [%y_dim_9, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 2>} : !tt.ptr<f16>, !tt.tensordesc<128x128xf16, #shared> loc(#loc134)
    %desc_dv_15 = tt.make_tensor_descriptor %desc_dv, [%y_dim_9, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 3>} : !tt.ptr<f16>, !tt.tensordesc<128x32xf16, #shared2> loc(#loc135)
    %desc_dk_16 = tt.make_tensor_descriptor %desc_dk, [%y_dim_9, %c128_i32], [%c128_i64, %c1_i64] {async_task_id = array<i32: 3>} : !tt.ptr<f16>, !tt.tensordesc<128x32xf16, #shared2> loc(#loc136)
    ...
    %tile_idx = scf.for %_ = %c0_i32 to %2 step %c1_i32 iter_args(%tile_idx_17 = %prog_id) -> (i32)  : i32 {
      ...
      %k_31 = tt.descriptor_load %desc_k_14[%k_30, %c0_i32] {async_task_id = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked3> loc(#loc186)
      ...
      %v_32 = tt.descriptor_load %desc_v_13[%k_30, %c0_i32] {async_task_id = array<i32: 2>} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked3> loc(#loc185)
      ...
      %curr_m:7 = scf.for %curr_m_66 = %c0_i32 to %num_steps step %c1_i32 iter_args(%arg19 = %c0_i32, %arg20 = %false, %qkT_67 = %qkT_2, %dv_68 = %dv_34, %dpT_69 = %dpT_1, %dk_70 = %dk_33, %dq_71 = %dq_0) -> (i32, i1, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token)  : i32 {
        ...
        %q_75 = tt.descriptor_load %desc_q_10[%q_74, %c0_i32] {async_task_id = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked3> loc(#loc217)
        ...
        %do_87 = tt.descriptor_load %desc_do_11[%q_74, %c0_i32] {async_task_id = array<i32: 2>, loop.cluster = 1 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x128xf16, #shared> -> tensor<128x128xf16, #blocked3> loc(#loc215)
        ...
        tt.descriptor_reduce add, %desc_dq_12[%q_74, %c0_i32], %dqN_119 {async_task_id = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x32xf32, #shared1>, tensor<128x32xf32, #blocked9> loc(#loc240)
        ...
        tt.descriptor_reduce add, %desc_dq_12[%q_74, %c32_i32], %dqN_121 {async_task_id = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x32xf32, #shared1>, tensor<128x32xf32, #blocked9> loc(#loc240)
        ...
        tt.descriptor_reduce add, %desc_dq_12[%q_74, %c64_i32], %dqN_123 {async_task_id = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x32xf32, #shared1>, tensor<128x32xf32, #blocked9> loc(#loc240)
        ...
        tt.descriptor_reduce add, %desc_dq_12[%q_74, %c96_i32], %dqN_125 {async_task_id = array<i32: 0>, loop.cluster = 2 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x32xf32, #shared1>, tensor<128x32xf32, #blocked9> loc(#loc240)
      ...
      tt.descriptor_store %desc_dv_15[%k_30, %c0_i32], %7 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x32xf16, #shared2>, tensor<128x32xf16, #blocked10> loc(#loc179)
      %8 = ttg.convert_layout %3 {async_task_id = array<i32: 3>} : tensor<128x32xf16, #blocked1> -> tensor<128x32xf16, #blocked10> loc(#loc178)
      tt.descriptor_store %desc_dv_15[%k_30, %c32_i32], %8 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x32xf16, #shared2>, tensor<128x32xf16, #blocked10> loc(#loc179)
      %9 = ttg.convert_layout %6 {async_task_id = array<i32: 3>} : tensor<128x32xf16, #blocked1> -> tensor<128x32xf16, #blocked10> loc(#loc178)
      tt.descriptor_store %desc_dv_15[%k_30, %c64_i32], %9 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x32xf16, #shared2>, tensor<128x32xf16, #blocked10> loc(#loc179)
      %10 = ttg.convert_layout %5 {async_task_id = array<i32: 3>} : tensor<128x32xf16, #blocked1> -> tensor<128x32xf16, #blocked10> loc(#loc178)
      tt.descriptor_store %desc_dv_15[%k_30, %c96_i32], %10 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x32xf16, #shared2>, tensor<128x32xf16, #blocked10> loc(#loc179)
      ...
      tt.descriptor_store %desc_dk_16[%k_30, %c0_i32], %12 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x32xf16, #shared2>, tensor<128x32xf16, #blocked10> loc(#loc182)
      ...
      tt.descriptor_store %desc_dk_16[%k_30, %c32_i32], %14 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x32xf16, #shared2>, tensor<128x32xf16, #blocked10> loc(#loc182)
      ...
      tt.descriptor_store %desc_dk_16[%k_30, %c64_i32], %16 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x32xf16, #shared2>, tensor<128x32xf16, #blocked10> loc(#loc182)
      ...
      tt.descriptor_store %desc_dk_16[%k_30, %c96_i32], %18 {async_task_id = array<i32: 3>} : !tt.tensordesc<128x32xf16, #shared2>, tensor<128x32xf16, #blocked10> loc(#loc182)
