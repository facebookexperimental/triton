...
// expected-remark @below {{c_nested0 case [608, 272]: mask={1}}}
// expected-remark @below {{d_nested1 case [1760, 272]: mask={4}}}
// expected-remark @below {{e_complement1 case [1728, 272]: mask={3}}}
// expected-remark @below {{f_dynamic case [608, 272]: mask={1}}}
// expected-remark @below {{f_dynamic case [1760, 272]: mask={4}}}
// expected-remark @below {{g_selected case [608, 272]: mask={1}}}
// expected-remark @below {{g_selected case [1760, 272]: mask={4}}}
// expected-remark @below {{state-plan: lanes=5}}
