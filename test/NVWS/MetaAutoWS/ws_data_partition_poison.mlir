...
module attributes {"ttg.num-warps" = 4 : i32, ttg.target = "cuda:100"} {
  // CHECK-LABEL: @poison_loop_desc
  tt.func @poison_loop_desc(%a_base: !tt.ptr<f16>, %b_base: !tt.ptr<f16>) {
    ...
    // CHECK: ub.poison : !tt.tensordesc<tensor<64x64xf16, #shared>>
    ...
    scf.for %k = %c0_i32 to %k_tiles step %c1_i32 iter_args(%acc = %zero, %flag = %true, %a_desc = %a_desc_undef, %b_desc = %b_desc_undef) -> (tensor<128x128xf32, #acc_layout>, i1, !tt.tensordesc<tensor<128x64xf16, #shared>>, !tt.tensordesc<tensor<64x128xf16, #shared>>) : i32 {
      %cur_a_desc, %cur_b_desc = scf.if %flag -> (!tt.tensordesc<tensor<128x64xf16, #shared>>, !tt.tensordesc<tensor<64x128xf16, #shared>>) {
      ...
      %a = tt.descriptor_load %a_desc[%k, %k] : !tt.tensordesc<tensor<128x64xf16, #shared>> -> tensor<128x64xf16, #oper_layout>
      %b = tt.descriptor_load %b_desc[%k, %k] : !tt.tensordesc<tensor<64x128xf16, #shared>> -> tensor<64x128xf16, #oper_layout>
