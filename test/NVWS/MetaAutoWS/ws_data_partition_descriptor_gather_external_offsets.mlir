// RUN: not triton-opt %s --nvws-ws-data-partition=num-warp-groups=3 -allow-unregistered-dialect
...
module attributes {"ttg.num-warps" = 4 : i32, ttg.target = "cuda:100"} {
  tt.func @descriptor_gather_external_offsets(%a_desc: !tt.tensordesc<tensor<1x64xf16, #shared>>, %b_desc: !tt.tensordesc<tensor<64x64xf16, #shared>>, %indices: tensor<128xi32, #indices_layout>) {
