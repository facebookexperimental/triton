...
#row_layout = #ttg.slice<{dim = 1, parent = #acc_layout}>
...
module attributes {"ttg.num-warps" = 4 : i32, ttg.target = "cuda:100"} {
  // CHECK-LABEL: @generic_result_op
  // CHECK: "sub_row_max"{{.*}} : (tensor<64x128xf32
  // CHECK-SAME: tensor<64xf32
  // CHECK-SAME: f32) -> tensor<64x128xf32
  tt.func @generic_result_op(%a_desc: !tt.tensordesc<tensor<128x64xf16, #shared>>, %b_desc: !tt.tensordesc<tensor<64x128xf16, #shared>>, %scale: f32) {
    %c0_i32 = arith.constant 0 : i32
    %true = arith.constant true
    %zero = arith.constant dense<0.0> : tensor<128x128xf32, #acc_layout>
    %row = arith.constant dense<1.0> : tensor<128xf32, #row_layout>
    ...
    %adj = "sub_row_max"(%c, %row, %scale) : (tensor<128x128xf32, #acc_layout>, tensor<128xf32, #row_layout>, f32) -> tensor<128x128xf32, #acc_layout>
    "use"(%adj) : (tensor<128x128xf32, #acc_layout>) -> ()
    tt.return
  }
}
