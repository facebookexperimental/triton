...
// CHECK: %dq, %dq_0 = ttng.tmem_alloc {{.*}}buffer.id = {{[0-9]+}} : i32, buffer.offset = 0 : i32
// CHECK: %dpT, %dpT_1 = ttng.tmem_alloc {{.*}}buffer.id = {{[0-9]+}} : i32
// CHECK: %ppT = ttng.tmem_alloc {{.*}}buffer.id = {{[0-9]+}} : i32, buffer.offset = 0 : i32
// CHECK: %qkT, %qkT_2 = ttng.tmem_alloc {{.*}}buffer.id = {{[0-9]+}} : i32
// CHECK: %dv, %dv_3 = ttng.tmem_alloc {{.*}}buffer.copy = 1 : i32, buffer.id = {{[0-9]+}} : i32
// CHECK: %dk, %dk_4 = ttng.tmem_alloc {{.*}}buffer.copy = 1 : i32, buffer.id = {{[0-9]+}} : i32
