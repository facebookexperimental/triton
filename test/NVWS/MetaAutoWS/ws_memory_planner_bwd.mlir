...
// CHECK: %qkT, %qkT_44 = ttng.tmem_alloc {{.*}}buffer.id = {{[0-9]+}} : i32
// CHECK: %dv_45, %dv_46 = ttng.tmem_alloc {{.*}}buffer.copy = 1 : i32, buffer.id = {{[0-9]+}} : i32
// CHECK: %dpT, %dpT_47 = ttng.tmem_alloc {{.*}}buffer.id = {{[0-9]+}} : i32
// CHECK: %dk, %dk_48 = ttng.tmem_alloc {{.*}}buffer.copy = 1 : i32, buffer.id = {{[0-9]+}} : i32
// CHECK: %dq, %dq_49 = ttng.tmem_alloc {{.*}}buffer.id = {{[0-9]+}} : i32, buffer.offset = 0 : i32
// CHECK: tmem.start
// CHECK: tmem.end
