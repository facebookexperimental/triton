           ...
           {sizePerThread = [1, 128],                                          \
                             threadsPerWarp = [32, 1],                         \
                                               warpsPerCTA = [4, 1],           \
                                                              order = [0,      \
                                                                       1] }>
#blocked1 = #ttg.blocked <                                                     \
            {sizePerThread = [1, 1],                                           \
                              threadsPerWarp = [1, 32],                        \
                                                warpsPerCTA = [2, 2],          \
                                                               order = [1,     \
                                                                        0] }>
#linear = #ttg.linear < {register = [[0, 1],                                   \
                                      [0, 2],                                  \
                                       [32, 0],                                \
                                        [64, 0], [0, 4]],                      \
                                         lane = [[1, 0],                       \
...
#shared1 = #ttg.nvmma_shared < {swizzlingByteWidth = 128, transposed = true,   \
                               elementBitWidth = 16 }>
#shared2 = #ttg.swizzled_shared < {vec = 1, perPhase = 1, maxPhase = 1,        \
                                  order = [1, 0] }>
#shared3 = #ttg.nvmma_shared < {swizzlingByteWidth = 128, transposed = false,  \
                               elementBitWidth = 8 }>
#shared4 = #ttg.nvmma_shared < {swizzlingByteWidth = 128, transposed = true,   \
                               elementBitWidth = 8 }>
...
module attributes{"ttg.num-warps" = 4 :i32, ttg.target = "cuda:100"} {
  ...
  tt.func @matmul_scaled_rhs_scales_tma(
      % arg0 : i32, % arg1 : i32, % arg2 : i32,
      % arg3 : !tt.tensordesc<tensor<128x64xf8E4M3FN, #shared3>>,
      % arg4 : !tt.tensordesc<tensor<128x64xf8E4M3FN, #shared3>>,
      % arg5 : !tt.tensordesc<tensor<128x8xi8, #shared2>>) {
    %true = arith.constant true
    %c0_i32 = arith.constant 0 : i32
    %c1_i32 = arith.constant 1 : i32
    %c64_i32 = arith.constant 64 : i32
