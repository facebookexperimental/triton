...
// MMA-only loop: no TMA copy, no result use. Under the honest latency
// model the single TC op has ResMII = 256, so II = 256 and the MMA
// lands at cycle 0, stage 0.
//
...
// II = ResMII = 256: TC pipeline occupancy of the lone MMA (honest latency model).
