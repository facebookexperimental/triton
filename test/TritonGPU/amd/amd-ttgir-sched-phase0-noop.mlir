...
// CHECK: remark: ttgir-sched: visited 1 scf.for op(s), 1 candidate(s), 1 MFMA tt.dot op(s), 1 planned M-split(s), 0 skipped, 0 bwd-infeasible, 0 fwd-infeasible, 0 applied (phase 2: plan only)
