...
// CHECK: remark: ttgir-sched: would M-split this dot into 8 (blockM=256 / ctaTileM=32), co-partitioning 1 producer op(s) + 1 user op(s) (phase 1d: plan only)
// CHECK: remark: ttgir-sched: candidate inner loop with 1 MFMA tt.dot op(s); plans 1, skipped 0, bwd-infeasible 0, fwd-infeasible 0, applied 0, co-partition producer-ops 1 + user-ops 1 (phase 1d: plan only)
...
// CHECK: remark: ttgir-sched: would M-split this dot into 8 (blockM=256 / ctaTileM=32), but backward walker bailed (phase 1d: plan only)
// CHECK: remark: ttgir-sched: candidate inner loop with 1 MFMA tt.dot op(s); plans 1, skipped 0, bwd-infeasible 1, fwd-infeasible 0, applied 0, co-partition producer-ops 0 + user-ops 0 (phase 1d: plan only)
