...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "hip:gfx1250", "ttg.threads-per-warp" = 32 : i32} {
  ...
  // CHECK: tt.make_tensor_descriptor {{.*}} : !tt.ptr<i16>, !tt.tensordesc<1x1024xi16, #[[$DESC_LAYOUT]]>
  ...
  tt.func public @rank_reduced_descriptor_load_pad_limit(
    ...
    %desc = tt.make_tensor_descriptor %base, [%c1_i32, %c1024_i32], [%stride, %c1_i64] : !tt.ptr<i16>, !tt.tensordesc<1x1024xi16>
...
module attributes {"ttg.num-ctas" = 2 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "hip:gfx1250", "ttg.threads-per-warp" = 32 : i32} {
  ...
  // CHECK: tt.make_tensor_descriptor {{.*}} : !tt.ptr<i16>, !tt.tensordesc<1x2048xi16, #[[$MC_DESC_LAYOUT]]>
  ...
  tt.func public @multi_cta_rank_reduced_descriptor_load(
    ...
    %desc = tt.make_tensor_descriptor %base, [%c1_i32, %c2048_i32], [%stride, %c1_i64] : !tt.ptr<i16>, !tt.tensordesc<1x2048xi16>
