...
// CHECK: remark: ttgir-sched: would M-split this dot into 16 (blockM=256 / instrM=16) (phase 1a: plan only)
...
// CHECK: remark: ttgir-sched: candidate inner loop with 1 MFMA tt.dot op(s); plans 0, skipped 1 (phase 1a: plan only)
// CHECK: remark: ttgir-sched: visited 1 scf.for op(s), 1 candidate(s), 1 MFMA tt.dot op(s), 0 planned M-split(s), 1 skipped (phase 1a: plan only)
