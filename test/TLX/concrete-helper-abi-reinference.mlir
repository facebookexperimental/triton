...
// CHECK-SAME: %[[ARG:.*]]: tensor<4x256xi8, #[[$SRC]]>)
// CHECK: %[[RESHAPE:.*]] = tt.reshape %[[ARG]]
// CHECK-SAME: -> tensor<4x4x16x2x2xi8, #[[$RESHAPED:.*]]>
// CHECK: %[[TRANSPOSE:.*]] = tt.trans %[[RESHAPE]]
// CHECK-SAME: -> tensor<4x2x16x2x4xi8, #[[$TRANSPOSED:.*]]>
// CHECK: tt.return %[[TRANSPOSE]] : tensor<4x2x16x2x4xi8, #[[$TRANSPOSED]]>
...
"builtin.module"() ({
  "tt.func"() <{
    function_type = (tensor<4x256xi8, #physical>) -> tensor<4x2x16x2x4xi8>,
    sym_name = "restructure",
    sym_visibility = "private"
  }> ({
  ^bb0(%arg0: tensor<4x256xi8, #physical>):
    %0 = "tt.reshape"(%arg0) <{allow_reorder}> :
      (tensor<4x256xi8, #physical>) -> tensor<4x4x16x2x2xi8>
  ...
  ^bb0(%arg0: tensor<4x256xi8>):
    %0 = "tlx.require_layout"(%arg0) :
      (tensor<4x256xi8>) -> tensor<4x256xi8, #physical>
    %1 = "tt.call"(%0) <{callee = @restructure}> :
      (tensor<4x256xi8, #physical>) -> tensor<4x2x16x2x4xi8>
    "tt.return"() : () -> ()
  }) : () -> ()
