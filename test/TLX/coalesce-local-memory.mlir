...
// CHECK-DAG: #[[$BLOCKED:.*]] = #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [32, 1], warpsPerCTA = [4, 1], order = [0, 1]}>
...
// CHECK: ttg.convert_layout %{{.*}} : tensor<128x64xf16, #[[$COALESCED]]> -> tensor<128x64xf16, #[[$BLOCKED]]>
