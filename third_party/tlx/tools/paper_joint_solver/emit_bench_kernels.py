...
longer part of the literal reproduction (see DEVIATIONS.md).  The v6-era TLX
bench artifacts remain the final performance record of the guarded regime;
no lit1 run drives this file.
