# SUPERSEDED (2026-08-05): v6-era one-shot probe against the pre-literalization
# solve_joint surface (probe kwargs, extended model). Kept for the audit trail
# only; do not port to the literal surface -- exact-set probes now go through
# solve_joint_audit(), and batch UNSAT evidence goes through
# python -m paper_joint_solver.probe.
