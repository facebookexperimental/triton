...
def fa_bwd_dkdv_5mma(
    ...
    # inner-loop buf 6: SMEM count=1 (channel for cross-WG hand-off; shares L0_smem_mg_4 (group 4))
    L0_smem_mg_4 = tlx.storage_alias_spec(storage=tlx.storage_kind.smem)
    L0_smem_6 = tlx.local_alloc((128, 64), tl.float16, 1, reuse=L0_smem_mg_4)
    # inner-loop buf 7: SMEM count=1 (channel for cross-WG hand-off; shares L0_smem_mg_4 (group 4))
    L0_smem_7 = tlx.local_alloc((128, 64), tl.float16, 1, reuse=L0_smem_mg_4)
    L0_smem_mg_4.set_buffer_overlap(tlx.reuse_group(L0_smem_6, L0_smem_7, group_type=tlx.reuse_group_type.shared))
