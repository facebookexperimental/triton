...
- Do not begin with an LLM-generated optimization plan. Require an
  instruction- or warp-level baseline profile and inspect its raw artifacts
  before proposing work.
- Identify concrete pipeline bubbles and their causal dependencies. Cite the
  relevant stall sites and predict how the change will reduce memory, MMA,
  barrier, or scheduler-wait gaps.
