...
class padded_shared_layout_encoding(shared_layout_encoding):
    ...
    def __init__(
        ...
        self.offset_bases = None if offset_bases is None else [list(base) for base in offset_bases]
        self.block_bases = [] if block_bases is None else [list(base) for base in block_bases]
