...
# Round-toward-zero opt-in. Off by default, matching the source kernel. The
# constexpr is baked into kernels at compile time rather than entering the JIT
# cache key.
...
def pid_swizzle(pid, off_hz, n_tile_num, HZ):
    """Swizzle adjacent AMD programs for locality within an XCD."""
    if IS_HIP:
