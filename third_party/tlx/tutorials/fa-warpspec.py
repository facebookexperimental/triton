    ...
    with tlx.async_tasks():
        ...
        with tlx.async_task(num_warps=1):  # gemm
            ...
            for start_n in tl.range(lo, hi, BLOCK_N):
                ...
                tlx.async_dot(buffer_q0, view_21, view_6, mmav5=True, useD=False, pred=start_n < val_121, view_18,
                              view_7)
                ...
                tlx.async_dot(buffer_q1, view_21, view_9, mmav5=True, useD=False, pred=start_n < val_121, view_18,
                              view_10)
