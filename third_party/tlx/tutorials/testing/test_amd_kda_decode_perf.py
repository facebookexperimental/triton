"""Performance harness for the generic gfx950 TLX KDA decode tutorial."""
...
import torch
import triton
from triton.language.extra.tlx.tutorials.amd_kda_decode import kda_recurrent_decode_tlx
...
def make_decode_runner(provider: str, inputs):
    ...
    def run():
        return kda_recurrent_decode_tlx(
            q,
            k,
            v,
            g,
