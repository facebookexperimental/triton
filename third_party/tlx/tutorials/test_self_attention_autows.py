...
if __name__ == "__main__":
    ...
    if len(sys.argv) >= 4 and sys.argv[1] in ("--run-dqreduce", "--run-clc", "--run-clc-mask-if"):
        ...
        assert A._AUTOWS_CFG.clc == (sys.argv[1] in ("--run-clc", "--run-clc-mask-if"))
