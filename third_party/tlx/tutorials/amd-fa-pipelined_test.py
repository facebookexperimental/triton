...
# These kernels are gfx950/MI350 (CDNA4)-specific and do not lower on
# gfx942/MI300, so the tests are gated to CDNA4 hardware.
_requires_cdna4 = pytest.mark.skipif(not is_hip_cdna4(), reason="Requires gfx950 hardware (CDNA4)")
