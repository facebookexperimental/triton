; ModuleID = '/data/users/xzhao9/meta-triton/python/triton/experimental/gsan/src/GSanLibrary.cu'
source_filename = "/data/users/xzhao9/meta-triton/python/triton/experimental/gsan/src/GSanLibrary.cu"
...
@.str10 = private unnamed_addr constant [44 x i8] c"false || !\22Unexpected atomic semantic type\22\00", align 1
@.str11 = private unnamed_addr constant [82 x i8] c"/data/users/xzhao9/meta-triton/python/triton/experimental/gsan/src/GSanLibrary.cu\00", align 1
@__PRETTY_FUNCTION__._ZN4gsan12_GLOBAL__N_115decodeAtomicSemEj = private unnamed_addr constant [65 x i8] c"AtomicSem gsan::(anonymous namespace)::decodeAtomicSem(uint32_t)\00", align 1
@.str12 = private unnamed_addr constant [36 x i8] c"false || !\22Unexpected atomic scope\22\00", align 1
@__PRETTY_FUNCTION__._ZN4gsan12_GLOBAL__N_117decodeAtomicScopeEj = private unnamed_addr constant [69 x i8] c"AtomicScope gsan::(anonymous namespace)::decodeAtomicScope(uint32_t)\00", align 1
@.str13 = private unnamed_addr constant [40 x i8] c"GSan clock buffer size must be non-zero\00", align 1
@.str14 = private unnamed_addr constant [35 x i8] c"GSan clock buffer token overflowed\00", align 1
...
for.body.lr.ph.i:                                 ; preds = %_ZN4gsan12_GLOBAL__N_114getThreadStateEPNS_11GlobalStateE.exit
  ...
  %numReads20.i.i.i.i = getelementptr inbounds nuw i8, ptr %4, i64 16
...
do.body.i.i.i:                                    ; preds = %if.then.i7, %do.body.i.i.i
  %16 = load atomic i32, ptr %lock.i.i syncscope("block") acquire, align 8
...
if.end.i4.i.i.i:                                  ; preds = %if.then.i.i.i.i, %_ZN4gsan12_GLOBAL__N_125assertOrderedOrCompatibleEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationEPKc.exit.i.i.i
  ...
  %cmp9.i.i.i.i = icmp ne i16 %bf.clear.i.i.i.i, %37
  %cmp11.i.i.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.i.i.i.i, 0
  %or.cond.not.i.i.i.i = select i1 %cmp9.i.i.i.i, i1 %cmp11.i.i.i.i, i1 false
  br i1 %or.cond.not.i.i.i.i, label %for.cond.i.i.i.i, label %if.then12.i.i.i.i
...
for.cond.i.i.i.i:                                 ; preds = %if.end.i4.i.i.i
  ...
  %cmp9.1.i.i.i.i = icmp ne i16 %bf.clear.1.i.i.i.i, %37
  %cmp11.1.i.i.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.1.i.i.i.i, 0
  %or.cond.not.1.i.i.i.i = select i1 %cmp9.1.i.i.i.i, i1 %cmp11.1.i.i.i.i, i1 false
  br i1 %or.cond.not.1.i.i.i.i, label %for.cond.1.i.i.i.i, label %if.then12.i.i.i.i
...
for.cond.1.i.i.i.i:                               ; preds = %for.cond.i.i.i.i
  ...
  %cmp9.2.i.i.i.i = icmp ne i16 %bf.clear.2.i.i.i.i, %37
  %cmp11.2.i.i.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.2.i.i.i.i, 0
  %or.cond.not.2.i.i.i.i = select i1 %cmp9.2.i.i.i.i, i1 %cmp11.2.i.i.i.i, i1 false
  br i1 %or.cond.not.2.i.i.i.i, label %for.cond.2.i.i.i.i, label %if.then12.i.i.i.i
...
for.cond.2.i.i.i.i:                               ; preds = %for.cond.1.i.i.i.i
  ...
  %cmp9.3.i.i.i.i = icmp ne i16 %bf.clear.3.i.i.i.i, %37
  %cmp11.3.i.i.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.3.i.i.i.i, 0
  %or.cond.not.3.i.i.i.i = select i1 %cmp9.3.i.i.i.i, i1 %cmp11.3.i.i.i.i, i1 false
  br i1 %or.cond.not.3.i.i.i.i, label %for.cond.3.i.i.i.i, label %if.then12.i.i.i.i

for.cond.3.i.i.i.i:                               ; preds = %for.cond.2.i.i.i.i
  %39 = atomicrmw add ptr %numReads20.i.i.i.i, i32 1 syncscope("block") monotonic, align 8
  %40 = load i32, ptr %rngSeed.i.i.i.i, align 16, !tbaa !34
  %conv23.i.i.i.i = zext i16 %37 to i32
  ...
  %mul.i.i6.i.i.i.i.i = mul i32 %conv23.i.i.i.i, -862048943
  ...
  %cmp26.i.i.i.i = icmp samesign ult i32 %rem.i.i.i.i, 4
  br i1 %cmp26.i.i.i.i, label %if.then27.i.i.i.i, label %_ZN4gsan12_GLOBAL__N_16doReadEPNS_11ThreadStateEPNS_10ShadowCellENS_8LocationE.exit.i.i

if.then12.i.i.i.i:                                ; preds = %for.cond.2.i.i.i.i, %for.cond.1.i.i.i.i, %for.cond.i.i.i.i, %if.end.i4.i.i.i
...
if.then27.i.i.i.i:                                ; preds = %for.cond.3.i.i.i.i
  %idxprom29.i.i.i.i = zext nneg i32 %rem.i.i.i.i to i64
  %arrayidx30.i.i.i.i = getelementptr inbounds nuw [4 x i8], ptr %17, i64 %idxprom29.i.i.i.i
  %scalarClock.sroa.5.0.arrayidx30.sroa_idx.i.i.i.i = getelementptr inbounds nuw i8, ptr %arrayidx30.i.i.i.i, i64 2
  store i16 %38, ptr %arrayidx30.i.i.i.i, align 4, !tbaa !22
  store i16 %bf.value.i.i.i.i.i, ptr %scalarClock.sroa.5.0.arrayidx30.sroa_idx.i.i.i.i, align 2, !tbaa !23
  br label %_ZN4gsan12_GLOBAL__N_16doReadEPNS_11ThreadStateEPNS_10ShadowCellENS_8LocationE.exit.i.i

_ZN4gsan12_GLOBAL__N_16doReadEPNS_11ThreadStateEPNS_10ShadowCellENS_8LocationE.exit.i.i: ; preds = %if.then27.i.i.i.i, %if.then12.i.i.i.i, %for.cond.3.i.i.i.i
...
if.then.i:                                        ; preds = %_ZN4gsan12_GLOBAL__N_114getThreadStateEPNS_11GlobalStateE.exit.i
  ...
  %conv.i18.i = zext i16 %11 to i64
  %mul.i19.i = mul nuw nsw i64 %div6.i.i, %conv.i18.i
  %add.i20.i = add nuw nsw i64 %mul.i19.i, %conv.i.i
  %vectorClock.i = getelementptr inbounds nuw i8, ptr %4, i64 30
  %idxprom.i = and i64 %add.i20.i, 65535
...
if.then7.i:                                       ; preds = %if.then.i
  %cmp.i21.i = icmp eq ptr %file, null
  %cond.i.i = select i1 %cmp.i21.i, ptr @.str, ptr %file
...
for.body23.i.i:                                   ; preds = %for.body23.i.i.preheader, %for.inc31.i.i
  %inc30.i.i19 = phi i8 [ %inc30.i.i18, %for.inc31.i.i ], [ 0, %for.body23.i.i.preheader ]
...
if.end26.i.i:                                     ; preds = %for.body23.i.i
  ...
  %31 = inttoptr i64 %add.i60.i.i to ptr
  %lock.i.i.i = getelementptr inbounds nuw i8, ptr %31, i64 22
  br label %while.cond.i61.i.i

while.cond.i61.i.i:                               ; preds = %while.cond.i61.i.i, %if.end26.i.i
  %32 = cmpxchg weak ptr %lock.i.i.i, i16 0, i16 1 acquire monotonic, align 2
  %33 = extractvalue { i16, i1 } %32, 1
  br i1 %33, label %_ZN4gsan12_GLOBAL__N_113acquireShadowEm.exit.i.i, label %while.cond.i61.i.i, !llvm.loop !26

_ZN4gsan12_GLOBAL__N_113acquireShadowEm.exit.i.i: ; preds = %while.cond.i61.i.i
  %inc30.i.i = add i8 %inc30.i.i19, 1
  %idxprom.i.i = zext i8 %inc30.i.i19 to i64
  %arrayidx.i.i = getelementptr inbounds nuw [8 x i8], ptr %cells.i.i, i64 %idxprom.i.i
  store ptr %31, ptr %arrayidx.i.i, align 8, !tbaa !49
  br label %for.inc31.i.i

for.inc31.i.i:                                    ; preds = %_ZN4gsan12_GLOBAL__N_113acquireShadowEm.exit.i.i, %for.body23.i.i
  %inc30.i.i18 = phi i8 [ %inc30.i.i, %_ZN4gsan12_GLOBAL__N_113acquireShadowEm.exit.i.i ], [ %inc30.i.i19, %for.body23.i.i ]
...
_ZN4gsan12_GLOBAL__N_124acquireAtomicShadowRangeEPNS_11ThreadStateEPNS_16AtomicEventStateEmiNS_8LocationE.exit.i.loopexit: ; preds = %for.inc31.i.i
  store i8 %inc30.i.i18, ptr %numCells16.i.i, align 8
...
_ZN4gsan12_GLOBAL__N_124acquireAtomicShadowRangeEPNS_11ThreadStateEPNS_16AtomicEventStateEmiNS_8LocationE.exit.i: ; preds = %_ZN4gsan12_GLOBAL__N_124acquireAtomicShadowRangeEPNS_11ThreadStateEPNS_16AtomicEventStateEmiNS_8LocationE.exit.i.loopexit, %_ZN4gsan12_GLOBAL__N_118rwLockAcquireWriteERj.exit.i.i, %do.end.i.i
  %34 = phi i8 [ %inc30.i.i18, %_ZN4gsan12_GLOBAL__N_124acquireAtomicShadowRangeEPNS_11ThreadStateEPNS_16AtomicEventStateEmiNS_8LocationE.exit.i.loopexit ], [ 0, %_ZN4gsan12_GLOBAL__N_118rwLockAcquireWriteERj.exit.i.i ], [ 0, %do.end.i.i ]
  br i1 %cmp13.i.i, label %_ZN4gsan12_GLOBAL__N_117beginAtomicAccessEPNS_11GlobalStateEPNS_16AtomicEventStateEbmijjNS_8LocationE.exit, label %if.end2.i
...
sw.default.i.i:                                   ; preds = %if.end2.i
  tail call fastcc void @_ZL13__assert_failPKcS0_jS0_(ptr noundef nonnull @.str10, ptr noundef nonnull @.str11, i32 noundef 173, ptr noundef nonnull @__PRETTY_FUNCTION__._ZN4gsan12_GLOBAL__N_115decodeAtomicSemEj) #8
  unreachable
...
sw.default.i52.i:                                 ; preds = %_ZN4gsan12_GLOBAL__N_115decodeAtomicSemEj.exit.i
  tail call fastcc void @_ZL13__assert_failPKcS0_jS0_(ptr noundef nonnull @.str12, ptr noundef nonnull @.str11, i32 noundef 186, ptr noundef nonnull @__PRETTY_FUNCTION__._ZN4gsan12_GLOBAL__N_117decodeAtomicScopeEj) #8
  unreachable

switch.lookup:                                    ; preds = %_ZN4gsan12_GLOBAL__N_115decodeAtomicSemEj.exit.i
  %cmp6111.not.i = icmp eq i8 %34, 0
  br i1 %cmp6111.not.i, label %for.cond.cleanup.i, label %for.body.lr.ph.i
...
for.body.lr.ph.i:                                 ; preds = %switch.lookup
  ...
  %numSms.i.i.i.i = getelementptr inbounds nuw i8, ptr %35, i64 20
  %globalsBase.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %35, i64 8
  %36 = getelementptr i8, ptr %35, i64 24
  %37 = getelementptr i8, ptr %35, i64 26
  %vectorClock.i.i.i.i = getelementptr inbounds nuw i8, ptr %10, i64 30
  %numReads20.i.i = getelementptr inbounds nuw i8, ptr %10, i64 16
  %rngSeed.i.i = getelementptr inbounds nuw i8, ptr %35, i64 16
  br label %for.body.i
...
for.cond11.preheader.i:                           ; preds = %for.cond.cleanup.i, %for.cond.cleanup.i
  br i1 %cmp6111.not.i, label %_ZN4gsan12_GLOBAL__N_117beginAtomicAccessEPNS_11GlobalStateEPNS_16AtomicEventStateEbmijjNS_8LocationE.exit, label %for.body17.lr.ph.i

for.body17.lr.ph.i:                               ; preds = %for.cond11.preheader.i
  %threadId.i70.i = getelementptr inbounds nuw i8, ptr %10, i64 28
  %and.i.i71.i = and i64 %add.i.i, -1073741824
  %38 = inttoptr i64 %and.i.i71.i to ptr
  %numSms.i.i.i103.i = getelementptr inbounds nuw i8, ptr %38, i64 20
  %globalsBase.i.i.i.i = getelementptr inbounds nuw i8, ptr %38, i64 8
  %39 = getelementptr i8, ptr %38, i64 24
  %40 = getelementptr i8, ptr %38, i64 26
  %vectorClock.i.i = getelementptr inbounds nuw i8, ptr %10, i64 30
  %clockBufferDirty.i93.i = getelementptr inbounds nuw i8, ptr %10, i64 20
...
for.body.i:                                       ; preds = %_ZN4gsan12_GLOBAL__N_110recordReadEPNS_11ThreadStateEPNS_10ShadowCellENS_11AtomicScopeE.exit.i, %for.body.lr.ph.i
  %i.0112.i = phi i8 [ 0, %for.body.lr.ph.i ], [ %inc.i, %_ZN4gsan12_GLOBAL__N_110recordReadEPNS_11ThreadStateEPNS_10ShadowCellENS_11AtomicScopeE.exit.i ]
  %idxprom.i = zext i8 %i.0112.i to i64
  %arrayidx.i = getelementptr inbounds nuw [8 x i8], ptr %cells.i.i, i64 %idxprom.i
  %41 = load ptr, ptr %arrayidx.i, align 8, !tbaa !49
  %writeClock.i = getelementptr inbounds nuw i8, ptr %41, i64 16
  %42 = load i32, ptr %writeClock.i, align 4
  %write.sroa.0.0.extract.trunc.i = trunc i32 %42 to i16
  %write.sroa.5.0.extract.shift.i = lshr i32 %42, 16
...
if.end.i.i:                                       ; preds = %for.body.i
  %43 = load i16, ptr %threadId.i56.i, align 4, !tbaa !22
  %bf.lshr.i.i = lshr i16 %write.sroa.5.0.extract.trunc.i, 12
  %44 = trunc nuw nsw i16 %bf.lshr.i.i to i8
  %bf.cast.i.i = and i8 %44, 3
...
sw.bb.i.i.i.i:                                    ; preds = %if.end.i.i.i
  %cmp.i10.i.i.i = icmp eq i16 %43, %bf.clear3.i.i
...
sw.bb2.i.i.i.i:                                   ; preds = %if.end.i.i.i
  %45 = load i16, ptr %numSms.i.i.i.i, align 4, !tbaa !21
  %46 = udiv i16 %43, %45
  %47 = udiv i16 %bf.clear3.i.i, %45
  %cmp9.i.i.i.i = icmp eq i16 %46, %47
  br label %_ZN4gsan12_GLOBAL__N_115scopeCoversPairENS_11AtomicScopeEttPNS_11GlobalStateE.exit.i.i.i

if.end.i.i.i.unreachabledefault:                  ; preds = %if.end.i.i.i
  unreachable

default.unreachable:                              ; preds = %land.rhs.i.i.i, %land.rhs.i.i74.i, %if.end.i.i73.i
  unreachable
...
sw.bb.i16.i.i.i:                                  ; preds = %land.rhs.i.i.i
  %cmp.i17.i.i.i = icmp eq i16 %43, %bf.clear3.i.i
...
sw.bb2.i13.i.i.i:                                 ; preds = %land.rhs.i.i.i
  %48 = load i16, ptr %numSms.i.i.i.i, align 4, !tbaa !21
  %49 = udiv i16 %43, %48
  %50 = udiv i16 %bf.clear3.i.i, %48
  %cmp9.i15.i.i.i = icmp eq i16 %49, %50
  br label %_ZN4gsan12_GLOBAL__N_125areAtomicScopesCompatibleENS_11AtomicScopeEtS1_tPNS_11GlobalStateE.exit.i.i
...
do.body.i.i:                                      ; preds = %_ZN4gsan12_GLOBAL__N_125areAtomicScopesCompatibleENS_11AtomicScopeEtS1_tPNS_11GlobalStateE.exit.i.i, %_ZN4gsan12_GLOBAL__N_115scopeCoversPairENS_11AtomicScopeEttPNS_11GlobalStateE.exit.i.i.i, %if.end.i.i
  %51 = and i16 %write.sroa.5.0.extract.trunc.i, 16384
  %bf.cast.not.i.i.i.i = icmp eq i16 %51, 0
...
if.end.i.i.i.i:                                   ; preds = %do.body.i.i
  ...
  %.frozen = freeze i16 %52
  %div16.i.i.i.i.i = udiv i16 %bf.clear3.i.i.frozen, %.frozen
  %53 = mul i16 %div16.i.i.i.i.i, %.frozen
  %rem17.i.i.i.i.i.decomposed = sub i16 %bf.clear3.i.i.frozen, %53
  %54 = load i64, ptr %globalsBase.i.i.i.i.i, align 8, !tbaa !20
  ...
  %ptr.biased.i.i.i.i.i.i.i = add i64 %add.i.i.i.i.i, %54
  %cond.i.i.i.i.i.i.i = and i64 %ptr.biased.i.i.i.i.i.i.i, -8
  %globals.val.i.i.i.i.i = load i16, ptr %36, align 8, !tbaa !11
  %globals.val15.i.i.i.i.i = load i16, ptr %37, align 2, !tbaa !15
  ...
  %55 = inttoptr i64 %add9.i.i.i.i.i to ptr
  %conv.i.i.i.i.i = and i32 %42, 65535
  %clockBufferHead.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %55, i64 20
...
do.end9.i.i.i.i.i:                                ; preds = %if.then4.i.i.i.i.i, %if.end.i.i.i.i
  ...
  %clockBufferSize.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %56, i64 26
  %57 = load i16, ptr %clockBufferSize.i.i.i.i.i, align 2, !tbaa !15
  %conv16.i.i.i.i.i = zext i16 %57 to i32
...
_ZN4gsan12_GLOBAL__N_118getClockBufferSlotEPNS_11ThreadStateEtNS_8LocationE.exit.i.i.i.i: ; preds = %if.then18.i.i.i.i.i, %do.end9.i.i.i.i.i
  %58 = phi i16 [ %.pre.i.i.i.i.i, %if.then18.i.i.i.i.i ], [ %57, %do.end9.i.i.i.i.i ]
  %59 = urem i16 %write.sroa.0.0.extract.trunc.i, %58
  %rem.i.i.i.i.i = zext i16 %59 to i64
  %vectorClock.i.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %55, i64 30
  %numThreads.i.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %56, i64 24
  %60 = load i16, ptr %numThreads.i.i.i.i.i.i, align 8, !tbaa !11
  %idx.ext.i.i.i.i.i.i = zext i16 %60 to i64
...
if.then1.i.i.i:                                   ; preds = %_ZN4gsan12_GLOBAL__N_119getSnapshotForWriteEPNS_11ThreadStateERKNS_11ScalarClockENS_8LocationE.exit.i.i.i
  %61 = load i16, ptr %36, align 8, !tbaa !11
  %conv.i.i.i.i = zext i16 %61 to i32
  %cmp.not11.i.i.i.i = icmp eq i16 %61, 0
...
for.body.i.i.i.i:                                 ; preds = %if.then1.i.i.i, %for.body.i.i.i.i
  ...
  %62 = load i16, ptr %arrayidx.i.i.i.i, align 2, !tbaa !22
  %arrayidx3.i.i.i.i = getelementptr inbounds nuw [2 x i8], ptr %retval.0.i.i22.i.i, i64 %idxprom.i.i.i.i
  %63 = load i16, ptr %arrayidx3.i.i.i.i, align 2, !tbaa !22
  %cmp5.i.i.i.i = icmp uge i16 %62, %63
...
cleanup.cont.i.i.i:                               ; preds = %cleanup.i.i.i
  ...
  %64 = load i16, ptr %arrayidx.i.i.i, align 2, !tbaa !22
  %cmp7.i.i.i = icmp uge i16 %64, %write.sroa.0.0.extract.trunc.i
...
_ZN4gsan12_GLOBAL__N_125assertOrderedOrCompatibleEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationEPKc.exit.i: ; preds = %if.then9.i.i, %_ZN4gsan12_GLOBAL__N_118clockHappensBeforeEPNS_11ThreadStateERKNS_11ScalarClockENS_8LocationE.exit.i.i, %_ZN4gsan12_GLOBAL__N_125areAtomicScopesCompatibleENS_11AtomicScopeEtS1_tPNS_11GlobalStateE.exit.i.i, %land.rhs.i.i.i, %for.body.i
  %numReads1.i.i = getelementptr inbounds nuw i8, ptr %41, i64 20
  %65 = load i16, ptr %numReads1.i.i, align 4, !tbaa !32
  %conv.i59.i = zext i16 %65 to i32
  %cmp.not.i.i = icmp eq i16 %65, -1
...
if.end.i62.i:                                     ; preds = %if.then.i60.i, %_ZN4gsan12_GLOBAL__N_125assertOrderedOrCompatibleEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationEPKc.exit.i
  %66 = load i16, ptr %threadId.i56.i, align 4, !tbaa !22
  %idxprom.i.i64.i = zext i16 %66 to i64
  %arrayidx.i.i65.i = getelementptr inbounds nuw [2 x i8], ptr %vectorClock.i.i.i.i, i64 %idxprom.i.i64.i
  %67 = load i16, ptr %arrayidx.i.i65.i, align 2, !tbaa !22
  %bf.value.i.i.i = and i16 %66, 4095
  %bf.set6.i.i.i = or disjoint i16 %bf.value.i.i.i, %7
  %readClock.sroa.0.0.copyload.i.i = load i16, ptr %41, align 4, !tbaa !22
  %readClock.sroa.4.0.arrayidx.sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %41, i64 2
  ...
  %cmp9.i.i = icmp ne i16 %bf.clear.i.i, %66
  %cmp11.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.i.i, 0
  %or.cond.not.i.i = select i1 %cmp9.i.i, i1 %cmp11.i.i, i1 false
  br i1 %or.cond.not.i.i, label %for.cond.i.i, label %if.then12.i.i

for.cond.i.i:                                     ; preds = %if.end.i62.i
  %arrayidx.1.i.i = getelementptr inbounds nuw i8, ptr %41, i64 4
  %readClock.sroa.0.0.copyload.1.i.i = load i16, ptr %arrayidx.1.i.i, align 4, !tbaa !22
  %readClock.sroa.4.0.arrayidx.sroa_idx.1.i.i = getelementptr inbounds nuw i8, ptr %41, i64 6
  ...
  %cmp9.1.i.i = icmp ne i16 %bf.clear.1.i.i, %66
  %cmp11.1.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.1.i.i, 0
  %or.cond.not.1.i.i = select i1 %cmp9.1.i.i, i1 %cmp11.1.i.i, i1 false
  br i1 %or.cond.not.1.i.i, label %for.cond.1.i.i, label %if.then12.i.i

for.cond.1.i.i:                                   ; preds = %for.cond.i.i
  %arrayidx.2.i.i = getelementptr inbounds nuw i8, ptr %41, i64 8
  %readClock.sroa.0.0.copyload.2.i.i = load i16, ptr %arrayidx.2.i.i, align 4, !tbaa !22
  %readClock.sroa.4.0.arrayidx.sroa_idx.2.i.i = getelementptr inbounds nuw i8, ptr %41, i64 10
  ...
  %cmp9.2.i.i = icmp ne i16 %bf.clear.2.i.i, %66
  %cmp11.2.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.2.i.i, 0
  %or.cond.not.2.i.i = select i1 %cmp9.2.i.i, i1 %cmp11.2.i.i, i1 false
  br i1 %or.cond.not.2.i.i, label %for.cond.2.i.i, label %if.then12.i.i

for.cond.2.i.i:                                   ; preds = %for.cond.1.i.i
  %arrayidx.3.i.i = getelementptr inbounds nuw i8, ptr %41, i64 12
  %readClock.sroa.0.0.copyload.3.i.i = load i16, ptr %arrayidx.3.i.i, align 4, !tbaa !22
  %readClock.sroa.4.0.arrayidx.sroa_idx.3.i.i = getelementptr inbounds nuw i8, ptr %41, i64 14
  ...
  %cmp9.3.i.i = icmp ne i16 %bf.clear.3.i.i, %66
  %cmp11.3.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.3.i.i, 0
  %or.cond.not.3.i.i = select i1 %cmp9.3.i.i, i1 %cmp11.3.i.i, i1 false
  br i1 %or.cond.not.3.i.i, label %for.cond.3.i.i, label %if.then12.i.i

for.cond.3.i.i:                                   ; preds = %for.cond.2.i.i
  %68 = atomicrmw add ptr %numReads20.i.i, i32 1 syncscope("block") monotonic, align 8
  %69 = load i32, ptr %rngSeed.i.i, align 16, !tbaa !34
  %conv23.i.i = zext i16 %66 to i32
  %mul.i.i.i.i67.i = mul i32 %68, -862048943
  %or.i.i.i.i.i.i = tail call noundef i32 @llvm.fshl.i32(i32 %mul.i.i.i.i67.i, i32 %mul.i.i.i.i67.i, i32 15)
  %mul1.i.i.i.i.i = mul i32 %or.i.i.i.i.i.i, 461845907
  %xor.i.i.i.i = xor i32 %mul1.i.i.i.i.i, %69
  ...
  %mul.i.i6.i.i.i = mul i32 %conv23.i.i, -862048943
  ...
  %70 = xor i32 %add.i12.i.i.i, %shr.i.i.i.i
  %xor.i13.i.i.i = xor i32 %70, 8
  ...
  %cmp26.i.i = icmp samesign ult i32 %rem.i.i, 4
  br i1 %cmp26.i.i, label %if.then27.i.i, label %_ZN4gsan12_GLOBAL__N_110recordReadEPNS_11ThreadStateEPNS_10ShadowCellENS_11AtomicScopeE.exit.i

if.then12.i.i:                                    ; preds = %for.cond.2.i.i, %for.cond.1.i.i, %for.cond.i.i, %if.end.i62.i
  %arrayidx.lcssa.i.i = phi ptr [ %41, %if.end.i62.i ], [ %arrayidx.1.i.i, %for.cond.i.i ], [ %arrayidx.2.i.i, %for.cond.1.i.i ], [ %arrayidx.3.i.i, %for.cond.2.i.i ]
  %readClock.sroa.4.0.arrayidx.sroa_idx.le.i.i = getelementptr inbounds nuw i8, ptr %arrayidx.lcssa.i.i, i64 2
  store i16 %67, ptr %arrayidx.lcssa.i.i, align 4, !tbaa !22
...
if.then27.i.i:                                    ; preds = %for.cond.3.i.i
  %idxprom29.i.i = zext nneg i32 %rem.i.i to i64
  %arrayidx30.i.i = getelementptr inbounds nuw [4 x i8], ptr %41, i64 %idxprom29.i.i
  %scalarClock.sroa.5.0.arrayidx30.sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %arrayidx30.i.i, i64 2
  store i16 %67, ptr %arrayidx30.i.i, align 4, !tbaa !22
  store i16 %bf.set6.i.i.i, ptr %scalarClock.sroa.5.0.arrayidx30.sroa_idx.i.i, align 2, !tbaa !23
  br label %_ZN4gsan12_GLOBAL__N_110recordReadEPNS_11ThreadStateEPNS_10ShadowCellENS_11AtomicScopeE.exit.i

_ZN4gsan12_GLOBAL__N_110recordReadEPNS_11ThreadStateEPNS_10ShadowCellENS_11AtomicScopeE.exit.i: ; preds = %if.then27.i.i, %if.then12.i.i, %for.cond.3.i.i
  %inc.i = add nuw i8 %i.0112.i, 1
  %cmp6.i = icmp ult i8 %inc.i, %34
...
for.body17.i:                                     ; preds = %_ZN4gsan12_GLOBAL__N_117maybeMergeAcquireEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationE.exit.i, %for.body17.lr.ph.i
  %i10.0114.i = phi i8 [ 0, %for.body17.lr.ph.i ], [ %inc25.i, %_ZN4gsan12_GLOBAL__N_117maybeMergeAcquireEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationE.exit.i ]
  %idxprom20.i = zext i8 %i10.0114.i to i64
  %arrayidx21.i = getelementptr inbounds nuw [8 x i8], ptr %cells.i.i, i64 %idxprom20.i
  %71 = load ptr, ptr %arrayidx21.i, align 8, !tbaa !49
  %writeClock22.i = getelementptr inbounds nuw i8, ptr %71, i64 16
  %72 = load i32, ptr %writeClock22.i, align 4
  %write18.sroa.0.0.extract.trunc.i = trunc i32 %72 to i16
  %write18.sroa.4.0.extract.shift.i = lshr i32 %72, 16
  %write18.sroa.4.0.extract.trunc.i = trunc nuw i32 %write18.sroa.4.0.extract.shift.i to i16
  %73 = and i16 %write18.sroa.4.0.extract.trunc.i, 16384
  %bf.cast.not.i.i = icmp eq i16 %73, 0
  br i1 %bf.cast.not.i.i, label %_ZN4gsan12_GLOBAL__N_117maybeMergeAcquireEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationE.exit.i, label %if.end.i69.i

if.end.i69.i:                                     ; preds = %for.body17.i
  %74 = load i16, ptr %threadId.i70.i, align 4, !tbaa !22
  %bf.lshr2.i.i = lshr i16 %write18.sroa.4.0.extract.trunc.i, 12
  %75 = trunc nuw nsw i16 %bf.lshr2.i.i to i8
  %bf.cast4.i.i = and i8 %75, 3
  %bf.clear7.i.i = and i16 %write18.sroa.4.0.extract.trunc.i, 4095
  %cmp.i9.i.not.i72.i = icmp eq i8 %bf.cast4.i.i, 0
  br i1 %cmp.i9.i.not.i72.i, label %_ZN4gsan12_GLOBAL__N_117maybeMergeAcquireEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationE.exit.i, label %if.end.i.i73.i

if.end.i.i73.i:                                   ; preds = %if.end.i69.i
  switch i8 %switch.masked, label %default.unreachable [
    i8 1, label %sw.bb.i.i.i107.i
    i8 2, label %sw.bb2.i.i.i102.i
    i8 3, label %land.rhs.i.i74.i
  ]

sw.bb.i.i.i107.i:                                 ; preds = %if.end.i.i73.i
  %cmp.i10.i.i108.i = icmp eq i16 %74, %bf.clear7.i.i
  br label %_ZN4gsan12_GLOBAL__N_115scopeCoversPairENS_11AtomicScopeEttPNS_11GlobalStateE.exit.i.i105.i

sw.bb2.i.i.i102.i:                                ; preds = %if.end.i.i73.i
  %76 = load i16, ptr %numSms.i.i.i103.i, align 4, !tbaa !21
  %77 = udiv i16 %74, %76
  %78 = udiv i16 %bf.clear7.i.i, %76
  %cmp9.i.i.i104.i = icmp eq i16 %77, %78
  br label %_ZN4gsan12_GLOBAL__N_115scopeCoversPairENS_11AtomicScopeEttPNS_11GlobalStateE.exit.i.i105.i

_ZN4gsan12_GLOBAL__N_115scopeCoversPairENS_11AtomicScopeEttPNS_11GlobalStateE.exit.i.i105.i: ; preds = %sw.bb2.i.i.i102.i, %sw.bb.i.i.i107.i
  %retval.0.i.i.i106.i = phi i1 [ %cmp9.i.i.i104.i, %sw.bb2.i.i.i102.i ], [ %cmp.i10.i.i108.i, %sw.bb.i.i.i107.i ]
  br i1 %retval.0.i.i.i106.i, label %land.rhs.i.i74.i, label %_ZN4gsan12_GLOBAL__N_117maybeMergeAcquireEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationE.exit.i

land.rhs.i.i74.i:                                 ; preds = %_ZN4gsan12_GLOBAL__N_115scopeCoversPairENS_11AtomicScopeEttPNS_11GlobalStateE.exit.i.i105.i, %if.end.i.i73.i
  switch i8 %bf.cast4.i.i, label %default.unreachable [
    i8 1, label %sw.bb.i16.i.i99.i
    i8 2, label %sw.bb2.i13.i.i94.i
    i8 3, label %if.end10.i.i
  ]

sw.bb.i16.i.i99.i:                                ; preds = %land.rhs.i.i74.i
  %cmp.i17.i.i100.i = icmp eq i16 %74, %bf.clear7.i.i
  br label %_ZN4gsan12_GLOBAL__N_125areAtomicScopesCompatibleENS_11AtomicScopeEtS1_tPNS_11GlobalStateE.exit.i97.i

sw.bb2.i13.i.i94.i:                               ; preds = %land.rhs.i.i74.i
  %79 = load i16, ptr %numSms.i.i.i103.i, align 4, !tbaa !21
  %80 = udiv i16 %74, %79
  %81 = udiv i16 %bf.clear7.i.i, %79
  %cmp9.i15.i.i96.i = icmp eq i16 %80, %81
  br label %_ZN4gsan12_GLOBAL__N_125areAtomicScopesCompatibleENS_11AtomicScopeEtS1_tPNS_11GlobalStateE.exit.i97.i

_ZN4gsan12_GLOBAL__N_125areAtomicScopesCompatibleENS_11AtomicScopeEtS1_tPNS_11GlobalStateE.exit.i97.i: ; preds = %sw.bb2.i13.i.i94.i, %sw.bb.i16.i.i99.i
  %retval.0.i.i98.i = phi i1 [ %cmp.i17.i.i100.i, %sw.bb.i16.i.i99.i ], [ %cmp9.i15.i.i96.i, %sw.bb2.i13.i.i94.i ]
  br i1 %retval.0.i.i98.i, label %if.end10.i.i, label %_ZN4gsan12_GLOBAL__N_117maybeMergeAcquireEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationE.exit.i

if.end10.i.i:                                     ; preds = %_ZN4gsan12_GLOBAL__N_125areAtomicScopesCompatibleENS_11AtomicScopeEtS1_tPNS_11GlobalStateE.exit.i97.i, %land.rhs.i.i74.i
  %82 = load i16, ptr %numSms.i.i.i103.i, align 4, !tbaa !21
  %bf.clear7.i.i.frozen = freeze i16 %bf.clear7.i.i
  %.frozen34 = freeze i16 %82
  %div16.i.i.i.i = udiv i16 %bf.clear7.i.i.frozen, %.frozen34
  %83 = mul i16 %div16.i.i.i.i, %.frozen34
  %rem17.i.i.i.i.decomposed = sub i16 %bf.clear7.i.i.frozen, %83
  %84 = load i64, ptr %globalsBase.i.i.i.i, align 8, !tbaa !20
  %conv5.i.i.i.i = zext nneg i16 %div16.i.i.i.i to i64
  %mul.i.i.i78.i = shl nuw nsw i64 %conv5.i.i.i.i, 30
  %add.i.i.i79.i = or disjoint i64 %mul.i.i.i78.i, 39
  %ptr.biased.i.i.i.i.i.i = add i64 %add.i.i.i79.i, %84
  %cond.i.i.i.i.i.i = and i64 %ptr.biased.i.i.i.i.i.i, -8
  %globals.val.i.i.i.i = load i16, ptr %39, align 8, !tbaa !11
  %globals.val15.i.i.i.i = load i16, ptr %40, align 2, !tbaa !15
  %conv.i.i.i.i80.i = zext i16 %globals.val15.i.i.i.i to i64
  %add.i.i.i.i81.i = add nuw nsw i64 %conv.i.i.i.i80.i, 1
  %conv1.i.i.i.i.i = zext i16 %globals.val.i.i.i.i to i64
  %mul.i.i.i.i82.i = shl nuw nsw i64 %conv1.i.i.i.i.i, 1
  %mul3.i.i.i.i.i = mul nuw nsw i64 %mul.i.i.i.i82.i, %add.i.i.i.i81.i
  ...
  %85 = inttoptr i64 %add9.i.i.i.i to ptr
  %conv.i.i.i83.i = and i32 %72, 65535
...
do.body1.i.i.i.i:                                 ; preds = %if.then.i.i.i.i, %if.end10.i.i
  %clockBufferHead.i.i.i.i = getelementptr inbounds nuw i8, ptr %85, i64 20
  %bf.load.i.i.i.i = load i32, ptr %clockBufferHead.i.i.i.i, align 4
  %bf.lshr.i.i.i.i = lshr i32 %bf.load.i.i.i.i, 1
  %cmp3.not.i.i.i.i = icmp samesign ult i32 %bf.lshr.i.i.i.i, %conv.i.i.i83.i
...
do.end9.i.i.i.i:                                  ; preds = %if.then4.i.i.i.i, %do.body1.i.i.i.i
  ...
  %and.i.i.i.i84.i = and i64 %add9.i.i.i.i, -1073741824
  %86 = inttoptr i64 %and.i.i.i.i84.i to ptr
  %sub.i.i.i.i = sub nsw i32 %bf.lshr14.pre-phi.i.i.i.i, %conv.i.i.i83.i
  %clockBufferSize.i.i.i.i = getelementptr inbounds nuw i8, ptr %86, i64 26
  %87 = load i16, ptr %clockBufferSize.i.i.i.i, align 2, !tbaa !15
  %conv16.i.i.i.i = zext i16 %87 to i32
...
_ZN4gsan12_GLOBAL__N_118getClockBufferSlotEPNS_11ThreadStateEtNS_8LocationE.exit.i.i.i: ; preds = %if.then18.i.i.i.i, %do.end9.i.i.i.i
  %88 = phi i16 [ %.pre.i.i.i.i, %if.then18.i.i.i.i ], [ %87, %do.end9.i.i.i.i ]
  %89 = urem i16 %write18.sroa.0.0.extract.trunc.i, %88
  %rem.i.i.i.i = zext i16 %89 to i64
  %vectorClock.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %85, i64 30
  %numThreads.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %86, i64 24
  %90 = load i16, ptr %numThreads.i.i.i.i.i, align 8, !tbaa !11
  %idx.ext.i.i.i.i.i = zext i16 %90 to i64
  %add.ptr.i.i.i.i85.i = getelementptr inbounds nuw [2 x i8], ptr %vectorClock.i.i.i.i.i, i64 %idx.ext.i.i.i.i.i
  %mul.i8.i.i.i = mul nuw nsw i64 %idx.ext.i.i.i.i.i, %rem.i.i.i.i
  %add.ptr.i.i.i.i = getelementptr inbounds nuw [2 x i8], ptr %add.ptr.i.i.i.i85.i, i64 %mul.i8.i.i.i
  %91 = load i16, ptr %39, align 8, !tbaa !11
  %cmp2.not.i.i = icmp eq i16 %91, 0
  br i1 %cmp2.not.i.i, label %_ZN4gsan12_GLOBAL__N_117maybeMergeAcquireEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationE.exit.i, label %for.body.i86.i

for.cond.cleanup.i92.i:                           ; preds = %for.inc.i.i
  br i1 %changed.1.off0.i.i, label %if.then25.i.i, label %_ZN4gsan12_GLOBAL__N_117maybeMergeAcquireEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationE.exit.i

for.body.i86.i:                                   ; preds = %_ZN4gsan12_GLOBAL__N_118getClockBufferSlotEPNS_11ThreadStateEtNS_8LocationE.exit.i.i.i, %for.inc.i.i
  %92 = phi i16 [ %95, %for.inc.i.i ], [ %91, %_ZN4gsan12_GLOBAL__N_118getClockBufferSlotEPNS_11ThreadStateEtNS_8LocationE.exit.i.i.i ]
  %i.04.i.i = phi i32 [ %inc.i89.i, %for.inc.i.i ], [ 0, %_ZN4gsan12_GLOBAL__N_118getClockBufferSlotEPNS_11ThreadStateEtNS_8LocationE.exit.i.i.i ]
  ...
  %idxprom.i87.i = zext nneg i32 %i.04.i.i to i64
  %arrayidx.i88.i = getelementptr inbounds nuw [2 x i8], ptr %vectorClock.i.i, i64 %idxprom.i87.i
  %93 = load i16, ptr %arrayidx.i88.i, align 2, !tbaa !22
  %arrayidx15.i.i = getelementptr inbounds nuw [2 x i8], ptr %add.ptr.i.i.i.i, i64 %idxprom.i87.i
  %94 = load i16, ptr %arrayidx15.i.i, align 2, !tbaa !22
  %cmp17.i.i = icmp ult i16 %93, %94
  br i1 %cmp17.i.i, label %if.then18.i.i, label %for.inc.i.i

if.then18.i.i:                                    ; preds = %for.body.i86.i
  store i16 %94, ptr %arrayidx.i88.i, align 2, !tbaa !22
  %.pre.i.i = load i16, ptr %39, align 8, !tbaa !11
  br label %for.inc.i.i

for.inc.i.i:                                      ; preds = %if.then18.i.i, %for.body.i86.i
  %95 = phi i16 [ %.pre.i.i, %if.then18.i.i ], [ %92, %for.body.i86.i ]
  %changed.1.off0.i.i = phi i1 [ true, %if.then18.i.i ], [ %changed.0.off03.i.i, %for.body.i86.i ]
  %inc.i89.i = add nuw nsw i32 %i.04.i.i, 1
  %conv.i90.i = zext i16 %95 to i32
  %cmp.i91.i = icmp samesign ult i32 %inc.i89.i, %conv.i90.i
  br i1 %cmp.i91.i, label %for.body.i86.i, label %for.cond.cleanup.i92.i, !llvm.loop !53

if.then25.i.i:                                    ; preds = %for.cond.cleanup.i92.i
  %bf.load26.i.i = load i32, ptr %clockBufferDirty.i93.i, align 4
  %bf.set.i.i = or i32 %bf.load26.i.i, 1
  store i32 %bf.set.i.i, ptr %clockBufferDirty.i93.i, align 4
...
_ZN4gsan12_GLOBAL__N_117maybeMergeAcquireEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationE.exit.i: ; preds = %if.then25.i.i, %for.cond.cleanup.i92.i, %_ZN4gsan12_GLOBAL__N_118getClockBufferSlotEPNS_11ThreadStateEtNS_8LocationE.exit.i.i.i, %_ZN4gsan12_GLOBAL__N_125areAtomicScopesCompatibleENS_11AtomicScopeEtS1_tPNS_11GlobalStateE.exit.i97.i, %_ZN4gsan12_GLOBAL__N_115scopeCoversPairENS_11AtomicScopeEttPNS_11GlobalStateE.exit.i.i105.i, %if.end.i69.i, %for.body17.i
  %inc25.i = add nuw i8 %i10.0114.i, 1
  %cmp15.i = icmp ult i8 %inc25.i, %34
...
if.then.i.i:                                      ; preds = %if.then.i
  ...
  tail call void @__assertfail(ptr noundef nonnull @.str13, ptr noundef nonnull %cond.i.i.i, i32 noundef %agg.tmp20.sroa.2.0.copyload, ptr noundef nonnull @.str2, i64 noundef 1) #8
...
do.end.i.i:                                       ; preds = %if.then.i.i, %if.then.i
  ...
  %cmp5.not.not.i.i = icmp ult i32 %bf.load.i.i212, 131070
  br i1 %cmp5.not.not.i.i, label %do.end12.i.i, label %if.then6.i.i

if.then6.i.i:                                     ; preds = %do.end.i.i
  %cmp.i37.i.i = icmp eq ptr %agg.tmp20.sroa.0.0.copyload, null
  %cond.i38.i.i = select i1 %cmp.i37.i.i, ptr @.str, ptr %agg.tmp20.sroa.0.0.copyload
  tail call void @__assertfail(ptr noundef nonnull @.str14, ptr noundef nonnull %cond.i38.i.i, i32 noundef %agg.tmp20.sroa.2.0.copyload, ptr noundef nonnull @.str2, i64 noundef 1) #8
  br label %do.end12.i.i

do.end12.i.i:                                     ; preds = %if.then6.i.i, %do.end.i.i
  ...
  %rem.i.i = urem i32 %add.i.i, %conv15.i.i
  %conv16.i.i = zext i16 %61 to i32
  %mul.i.i = mul nuw i32 %rem.i.i, %conv16.i.i
  %idx.ext.i.i = zext i32 %mul.i.i to i64
  %add.ptr.i.i = getelementptr inbounds nuw [2 x i8], ptr %add.ptr.i.i.i, i64 %idx.ext.i.i
  %cmp1940.not.i.i = icmp eq i16 %61, 0
  br i1 %cmp1940.not.i.i, label %_ZN4gsan12_GLOBAL__N_125appendClockBufferSnapshotEPNS_11ThreadStateEPKtNS_8LocationE.exit.i, label %for.body.i.i

for.body.i.i:                                     ; preds = %do.end12.i.i, %for.body.i.i
  %i.041.i.i = phi i32 [ %inc.i.i, %for.body.i.i ], [ 0, %do.end12.i.i ]
  %idxprom.i.i214 = zext nneg i32 %i.041.i.i to i64
  ...
  %arrayidx21.i.i = getelementptr inbounds nuw [2 x i8], ptr %add.ptr.i.i, i64 %idxprom.i.i214
  store i16 %63, ptr %arrayidx21.i.i, align 2, !tbaa !22
  %inc.i.i = add nuw nsw i32 %i.041.i.i, 1
  %64 = load i16, ptr %numThreads.i.i.i213, align 8, !tbaa !11
  %conv18.i.i = zext i16 %64 to i32
  %cmp19.i.i = icmp samesign ult i32 %inc.i.i, %conv18.i.i
  br i1 %cmp19.i.i, label %for.body.i.i, label %_ZN4gsan12_GLOBAL__N_125appendClockBufferSnapshotEPNS_11ThreadStateEPKtNS_8LocationE.exit.i, !llvm.loop !59

_ZN4gsan12_GLOBAL__N_125appendClockBufferSnapshotEPNS_11ThreadStateEPKtNS_8LocationE.exit.i: ; preds = %for.body.i.i, %do.end12.i.i
...
if.then.i.i265:                                   ; preds = %_ZN4gsan12_GLOBAL__N_118getClockBufferSlotEPNS_11ThreadStateEtNS_8LocationE.exit.i.i
  ...
  tail call void @__assertfail(ptr noundef nonnull @.str13, ptr noundef nonnull %cond.i.i.i267, i32 noundef %agg.tmp28.sroa.2.0.copyload, ptr noundef nonnull @.str2, i64 noundef 1) #8
...
do.end.i.i236:                                    ; preds = %if.then.i.i265, %_ZN4gsan12_GLOBAL__N_118getClockBufferSlotEPNS_11ThreadStateEtNS_8LocationE.exit.i.i
  ...
  %cmp5.not.not.i.i240 = icmp ult i32 %bf.load.i.i237, 131070
  br i1 %cmp5.not.not.i.i240, label %do.end12.i.i244, label %if.then6.i.i241

if.then6.i.i241:                                  ; preds = %do.end.i.i236
  %cmp.i37.i.i242 = icmp eq ptr %agg.tmp28.sroa.0.0.copyload, null
  %cond.i38.i.i243 = select i1 %cmp.i37.i.i242, ptr @.str, ptr %agg.tmp28.sroa.0.0.copyload
  tail call void @__assertfail(ptr noundef nonnull @.str14, ptr noundef nonnull %cond.i38.i.i243, i32 noundef %agg.tmp28.sroa.2.0.copyload, ptr noundef nonnull @.str2, i64 noundef 1) #8
  br label %do.end12.i.i244

do.end12.i.i244:                                  ; preds = %if.then6.i.i241, %do.end.i.i236
  ...
  %conv15.i.i248 = zext i16 %86 to i32
  %rem.i.i249 = urem i32 %add.i.i239, %conv15.i.i248
  %conv16.i.i250 = zext i16 %85 to i32
  %mul.i.i251 = mul nuw i32 %rem.i.i249, %conv16.i.i250
  ...
  %cmp1940.not.i.i254 = icmp eq i16 %85, 0
  br i1 %cmp1940.not.i.i254, label %_ZN4gsan12_GLOBAL__N_128propagateClockBufferSnapshotEPNS_11ThreadStateERKNS_11ScalarClockENS_8LocationE.exit, label %for.body.i.i255

for.body.i.i255:                                  ; preds = %do.end12.i.i244, %for.body.i.i255
  %i.041.i.i256 = phi i32 [ %inc.i.i260, %for.body.i.i255 ], [ 0, %do.end12.i.i244 ]
  %idxprom.i.i257 = zext nneg i32 %i.041.i.i256 to i64
  ...
  %arrayidx21.i.i259 = getelementptr inbounds nuw [2 x i8], ptr %add.ptr.i.i253, i64 %idxprom.i.i257
  store i16 %87, ptr %arrayidx21.i.i259, align 2, !tbaa !22
  %inc.i.i260 = add nuw nsw i32 %i.041.i.i256, 1
  %88 = load i16, ptr %76, align 8, !tbaa !11
  %conv18.i.i261 = zext i16 %88 to i32
  %cmp19.i.i262 = icmp samesign ult i32 %inc.i.i260, %conv18.i.i261
  br i1 %cmp19.i.i262, label %for.body.i.i255, label %_ZN4gsan12_GLOBAL__N_128propagateClockBufferSnapshotEPNS_11ThreadStateERKNS_11ScalarClockENS_8LocationE.exit, !llvm.loop !59

_ZN4gsan12_GLOBAL__N_128propagateClockBufferSnapshotEPNS_11ThreadStateERKNS_11ScalarClockENS_8LocationE.exit: ; preds = %for.body.i.i255, %do.end12.i.i244
  %bf.value.i.i264 = shl i32 %add.i.i239, 1
  %conv24.i.i = trunc i32 %add.i.i239 to i16
...
if.end36:                                         ; preds = %_ZN4gsan12_GLOBAL__N_128propagateClockBufferSnapshotEPNS_11ThreadStateERKNS_11ScalarClockENS_8LocationE.exit, %if.else32, %_ZN4gsan12_GLOBAL__N_125publishCurrentVectorClockEPNS_11ThreadStateENS_8LocationE.exit
  %retval.0.i216.pn = phi i16 [ %retval.0.i216, %_ZN4gsan12_GLOBAL__N_125publishCurrentVectorClockEPNS_11ThreadStateENS_8LocationE.exit ], [ %conv24.i.i, %_ZN4gsan12_GLOBAL__N_128propagateClockBufferSnapshotEPNS_11ThreadStateERKNS_11ScalarClockENS_8LocationE.exit ], [ %93, %if.else32 ]
...
for.body.i.i.preheader:                           ; preds = %_ZN4gsan12_GLOBAL__N_114getThreadStateEPNS_11GlobalStateE.exit.i
  ...
  br i1 %min.iters.check, label %for.body.i.i.preheader16, label %vector.ph
...
vector.ph:                                        ; preds = %for.body.i.i.preheader
  ...
  %broadcast.splat = shufflevector <2 x i64> %broadcast.splatinsert, <2 x i64> poison, <2 x i32> zeroinitializer
  %broadcast.splatinsert13 = insertelement <2 x i64> poison, i64 %sub.i.i48.i, i64 0
  %broadcast.splat14 = shufflevector <2 x i64> %broadcast.splatinsert13, <2 x i64> poison, <2 x i32> zeroinitializer
  %induction = add <2 x i64> %broadcast.splat14, <i64 0, i64 4>
  br label %vector.body
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.cond.cleanup.i.i, label %for.body.i.i.preheader16

for.body.i.i.preheader16:                         ; preds = %for.body.i.i.preheader, %middle.block
...
for.body.i.i:                                     ; preds = %for.body.i.i.preheader16, %for.body.i.i
  %addr.064.i.i = phi i64 [ %add5.i.i, %for.body.i.i ], [ %addr.064.i.i.ph, %for.body.i.i.preheader16 ]
  %numCells.063.i.i = phi i8 [ %spec.select.i.i, %for.body.i.i ], [ %numCells.063.i.i.ph, %for.body.i.i.preheader16 ]
  %and.i.i.i.i = and i64 %addr.064.i.i, -1099511627776
...
for.body.lr.ph.i:                                 ; preds = %switch.lookup
  ...
  %37 = shl i16 %36, 12
  %numReads20.i.i = getelementptr inbounds nuw i8, ptr %4, i64 16
...
for.cond.cleanup.i:                               ; preds = %for.cond.cleanup.loopexit.i, %switch.lookup
  %cmp15113.not.i = phi i1 [ %38, %for.cond.cleanup.loopexit.i ], [ true, %switch.lookup ]
  switch i8 %switch.idx.cast.i.i, label %_ZN4gsan12_GLOBAL__N_117beginAtomicAccessEPNS_11GlobalStateEPNS_16AtomicEventStateEbmijjNS_8LocationE.exit [
    i8 3, label %for.cond11.preheader.i
    i8 1, label %for.cond11.preheader.i
  ]
...
for.cond11.preheader.i:                           ; preds = %for.cond.cleanup.i, %for.cond.cleanup.i
  br i1 %cmp15113.not.i, label %_ZN4gsan12_GLOBAL__N_117beginAtomicAccessEPNS_11GlobalStateEPNS_16AtomicEventStateEbmijjNS_8LocationE.exit, label %for.body17.lr.ph.i

for.body17.lr.ph.i:                               ; preds = %for.cond11.preheader.i
  %cells19.i = getelementptr inbounds nuw i8, ptr %eventState, i64 8
  %threadId.i70.i = getelementptr inbounds nuw i8, ptr %4, i64 28
  %and.i.i71.i = and i64 %add.i.i, -1073741824
  %39 = inttoptr i64 %and.i.i71.i to ptr
  %numSms.i.i.i103.i = getelementptr inbounds nuw i8, ptr %39, i64 20
  ...
  %clockBufferDirty.i93.i = getelementptr inbounds nuw i8, ptr %4, i64 20
  br label %for.body17.i
...
if.end.i62.i:                                     ; preds = %if.then.i60.i, %_ZN4gsan12_GLOBAL__N_125assertOrderedOrCompatibleEPNS_11ThreadStateENS_11AtomicScopeERKNS_11ScalarClockENS_8LocationEPKc.exit.i
  ...
  %readClock.sroa.4.0.copyload.i.i = load i16, ptr %readClock.sroa.4.0.arrayidx.sroa_idx.i.i, align 2, !tbaa !23
  %bf.clear.i.i = and i16 %readClock.sroa.4.0.copyload.i.i, 4095
  %cmp9.i.i = icmp ne i16 %bf.clear.i.i, %67
  %cmp11.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.i.i, 0
  %or.cond.not.i.i = select i1 %cmp9.i.i, i1 %cmp11.i.i, i1 false
  br i1 %or.cond.not.i.i, label %for.cond.i.i, label %if.then12.i.i
...
for.cond.i.i:                                     ; preds = %if.end.i62.i
  ...
  %readClock.sroa.4.0.copyload.1.i.i = load i16, ptr %readClock.sroa.4.0.arrayidx.sroa_idx.1.i.i, align 2, !tbaa !23
  %bf.clear.1.i.i = and i16 %readClock.sroa.4.0.copyload.1.i.i, 4095
  %cmp9.1.i.i = icmp ne i16 %bf.clear.1.i.i, %67
  %cmp11.1.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.1.i.i, 0
  %or.cond.not.1.i.i = select i1 %cmp9.1.i.i, i1 %cmp11.1.i.i, i1 false
  br i1 %or.cond.not.1.i.i, label %for.cond.1.i.i, label %if.then12.i.i
...
for.cond.1.i.i:                                   ; preds = %for.cond.i.i
  ...
  %readClock.sroa.4.0.copyload.2.i.i = load i16, ptr %readClock.sroa.4.0.arrayidx.sroa_idx.2.i.i, align 2, !tbaa !23
  %bf.clear.2.i.i = and i16 %readClock.sroa.4.0.copyload.2.i.i, 4095
  %cmp9.2.i.i = icmp ne i16 %bf.clear.2.i.i, %67
  %cmp11.2.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.2.i.i, 0
  %or.cond.not.2.i.i = select i1 %cmp9.2.i.i, i1 %cmp11.2.i.i, i1 false
  br i1 %or.cond.not.2.i.i, label %for.cond.2.i.i, label %if.then12.i.i
...
for.cond.2.i.i:                                   ; preds = %for.cond.1.i.i
  ...
  %readClock.sroa.4.0.copyload.3.i.i = load i16, ptr %readClock.sroa.4.0.arrayidx.sroa_idx.3.i.i, align 2, !tbaa !23
  %bf.clear.3.i.i = and i16 %readClock.sroa.4.0.copyload.3.i.i, 4095
  %cmp9.3.i.i = icmp ne i16 %bf.clear.3.i.i, %67
  %cmp11.3.i.i = icmp ne i16 %readClock.sroa.0.0.copyload.3.i.i, 0
  %or.cond.not.3.i.i = select i1 %cmp9.3.i.i, i1 %cmp11.3.i.i, i1 false
  br i1 %or.cond.not.3.i.i, label %for.cond.3.i.i, label %if.then12.i.i

for.cond.3.i.i:                                   ; preds = %for.cond.2.i.i
  %69 = atomicrmw add ptr %numReads20.i.i, i32 1 syncscope("block") monotonic, align 8
  %70 = load i32, ptr %rngSeed.i.i, align 16, !tbaa !34
  %conv23.i.i = zext i16 %67 to i32
  %mul.i.i.i.i67.i = mul i32 %69, -862048943
  %or.i.i.i.i.i.i = tail call noundef i32 @llvm.fshl.i32(i32 %mul.i.i.i.i67.i, i32 %mul.i.i.i.i67.i, i32 15)
  %mul1.i.i.i.i.i = mul i32 %or.i.i.i.i.i.i, 461845907
...
if.then27.i.i:                                    ; preds = %for.cond.3.i.i
  %idxprom29.i.i = zext nneg i32 %rem.i.i to i64
  %arrayidx30.i.i = getelementptr inbounds nuw [4 x i8], ptr %42, i64 %idxprom29.i.i
  %scalarClock.sroa.5.0.arrayidx30.sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %arrayidx30.i.i, i64 2
  store i16 %68, ptr %arrayidx30.i.i, align 4, !tbaa !22
  store i16 %bf.set6.i.i.i, ptr %scalarClock.sroa.5.0.arrayidx30.sroa_idx.i.i, align 2, !tbaa !23
  br label %_ZN4gsan12_GLOBAL__N_110recordReadEPNS_11ThreadStateEPNS_10ShadowCellENS_11AtomicScopeE.exit.i
...
if.end.i69.i:                                     ; preds = %for.body17.i
  %76 = load i16, ptr %threadId.i70.i, align 4, !tbaa !22
  %bf.lshr2.i.i = lshr i16 %write18.sroa.4.0.extract.trunc.i, 12
...
sw.bb.i.i.i107.i:                                 ; preds = %if.end.i.i73.i
  %cmp.i10.i.i108.i = icmp eq i16 %76, %bf.clear7.i.i
  br label %_ZN4gsan12_GLOBAL__N_115scopeCoversPairENS_11AtomicScopeEttPNS_11GlobalStateE.exit.i.i105.i

sw.bb2.i.i.i102.i:                                ; preds = %if.end.i.i73.i
  %78 = load i16, ptr %numSms.i.i.i103.i, align 4, !tbaa !21
  %79 = udiv i16 %76, %78
  %80 = udiv i16 %bf.clear7.i.i, %78
  %cmp9.i.i.i104.i = icmp eq i16 %79, %80
  br label %_ZN4gsan12_GLOBAL__N_115scopeCoversPairENS_11AtomicScopeEttPNS_11GlobalStateE.exit.i.i105.i
...
sw.bb.i16.i.i99.i:                                ; preds = %land.rhs.i.i74.i
  %cmp.i17.i.i100.i = icmp eq i16 %76, %bf.clear7.i.i
  br label %_ZN4gsan12_GLOBAL__N_125areAtomicScopesCompatibleENS_11AtomicScopeEtS1_tPNS_11GlobalStateE.exit.i97.i

sw.bb2.i13.i.i94.i:                               ; preds = %land.rhs.i.i74.i
  %81 = load i16, ptr %numSms.i.i.i103.i, align 4, !tbaa !21
  %82 = udiv i16 %76, %81
  %83 = udiv i16 %bf.clear7.i.i, %81
  %cmp9.i15.i.i96.i = icmp eq i16 %82, %83
  br label %_ZN4gsan12_GLOBAL__N_125areAtomicScopesCompatibleENS_11AtomicScopeEtS1_tPNS_11GlobalStateE.exit.i97.i
...
if.end10.i.i:                                     ; preds = %_ZN4gsan12_GLOBAL__N_125areAtomicScopesCompatibleENS_11AtomicScopeEtS1_tPNS_11GlobalStateE.exit.i97.i, %land.rhs.i.i74.i
  %84 = load i16, ptr %numSms.i.i.i103.i, align 4, !tbaa !21
  %bf.clear7.i.i.frozen = freeze i16 %bf.clear7.i.i
  %.frozen19 = freeze i16 %84
  %div16.i.i.i.i = udiv i16 %bf.clear7.i.i.frozen, %.frozen19
  %85 = mul i16 %div16.i.i.i.i, %.frozen19
  %rem17.i.i.i.i.decomposed = sub i16 %bf.clear7.i.i.frozen, %85
  %86 = load i64, ptr %globalsBase.i.i.i.i, align 8, !tbaa !20
  %conv5.i.i.i.i = zext nneg i16 %div16.i.i.i.i to i64
  %mul.i.i.i78.i = shl nuw nsw i64 %conv5.i.i.i.i, 30
  %add.i.i.i79.i = or disjoint i64 %mul.i.i.i78.i, 39
  %ptr.biased.i.i.i.i.i.i = add i64 %add.i.i.i79.i, %86
  %cond.i.i.i.i.i.i = and i64 %ptr.biased.i.i.i.i.i.i, -8
  ...
  %conv.i.i.i83.i = and i32 %74, 65535
  %cmp.not.i.i.i.i = icmp eq i16 %write18.sroa.0.0.extract.trunc.i, 0
  br i1 %cmp.not.i.i.i.i, label %if.then.i.i.i.i, label %do.body1.i.i.i.i
...
do.end9.i.i.i.i:                                  ; preds = %if.then4.i.i.i.i, %do.body1.i.i.i.i
  %bf.lshr14.pre-phi.i.i.i.i = phi i32 [ %bf.lshr.i.i.i.i, %do.body1.i.i.i.i ], [ %.pre42.i.i.i.i, %if.then4.i.i.i.i ]
  %and.i.i.i.i84.i = and i64 %add9.i.i.i.i, -1073741824
  %88 = inttoptr i64 %and.i.i.i.i84.i to ptr
  %sub.i.i.i.i = sub nsw i32 %bf.lshr14.pre-phi.i.i.i.i, %conv.i.i.i83.i
...
for.body.i86.i:                                   ; preds = %_ZN4gsan12_GLOBAL__N_118getClockBufferSlotEPNS_11ThreadStateEtNS_8LocationE.exit.i.i.i, %for.inc.i.i
  ...
  %idxprom.i87.i = zext nneg i32 %i.04.i.i to i64
  %arrayidx.i88.i = getelementptr inbounds nuw [2 x i8], ptr %vectorClock.i.i, i64 %idxprom.i87.i
  %95 = load i16, ptr %arrayidx.i88.i, align 2, !tbaa !22
  %arrayidx15.i.i = getelementptr inbounds nuw [2 x i8], ptr %add.ptr.i.i.i.i, i64 %idxprom.i87.i
...
if.then18.i.i:                                    ; preds = %for.body.i86.i
  store i16 %96, ptr %arrayidx.i88.i, align 2, !tbaa !22
  %.pre.i.i = load i16, ptr %40, align 8, !tbaa !11
  br label %for.inc.i.i

for.inc.i.i:                                      ; preds = %if.then18.i.i, %for.body.i86.i
  %97 = phi i16 [ %.pre.i.i, %if.then18.i.i ], [ %94, %for.body.i86.i ]
  %changed.1.off0.i.i = phi i1 [ true, %if.then18.i.i ], [ %changed.0.off03.i.i, %for.body.i86.i ]
  %inc.i89.i = add nuw nsw i32 %i.04.i.i, 1
  %conv.i90.i = zext i16 %97 to i32
  %cmp.i91.i = icmp samesign ult i32 %inc.i89.i, %conv.i90.i
  br i1 %cmp.i91.i, label %for.body.i86.i, label %for.cond.cleanup.i92.i, !llvm.loop !53
...
; Function Attrs: convergent inlinehint mustprogress nounwind denormal_fpenv(float: preservesign)
define internal fastcc void @_ZL13__assert_failPKcS0_jS0_(ptr noundef %__message, ptr noundef %__file, i32 noundef %__line, ptr noundef %__function) unnamed_addr #4 {
entry:
  tail call void @__assertfail(ptr noundef %__message, ptr noundef %__file, i32 noundef %__line, ptr noundef %__function, i64 noundef 1) #8
  ret void
}

; Function Attrs: convergent nounwind denormal_fpenv(float: preservesign)
declare dso_local void @__assertfail(ptr noundef, ptr noundef, i32 noundef, ptr noundef, i64 noundef) local_unnamed_addr #5
...
attributes #0 = { mustprogress nofree norecurse nosync nounwind willreturn denormal_fpenv(float: preservesign) memory(argmem: read) "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="sm_80" "target-features"="+ptx70,+sm_80" "uniform-work-group-size" }
attributes #1 = { convergent mustprogress nounwind denormal_fpenv(float: preservesign) "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="sm_80" "target-features"="+ptx70,+sm_80" "uniform-work-group-size" }
attributes #2 = { mustprogress nocallback nofree nosync nounwind willreturn memory(argmem: readwrite) }
attributes #3 = { mustprogress nocallback nofree nosync nounwind speculatable willreturn memory(none) }
attributes #4 = { convergent inlinehint mustprogress nounwind denormal_fpenv(float: preservesign) "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="sm_80" "target-features"="+ptx70,+sm_80" "uniform-work-group-size" }
attributes #5 = { convergent nounwind denormal_fpenv(float: preservesign) "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="sm_80" "target-features"="+ptx70,+sm_80" "uniform-work-group-size" }
