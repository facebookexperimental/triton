...
/// Build and validate ordinary loop-cadence channel protocols, A1/A2/A3 SMEM
/// reuse groups, A5 cross-partition TMEM reuse, and the coalesced
/// staging-to-operand reuse WAR protocol. Other physical reuse and specialized
/// protocol shapes remain conservatively unsupported.
