...
static bool needAccumCntForReuse(Operation *ctrlOp, ReuseGroup *group) {
  ...
  // or erase this channel's producer before we reach here (see ChannelPost's
...
//                    reuse (some real kernels, e.g. HSTU 2-KV reduce_dq, rely on
//                    it; dropping it globally regressed FA-bwd + HSTU).
