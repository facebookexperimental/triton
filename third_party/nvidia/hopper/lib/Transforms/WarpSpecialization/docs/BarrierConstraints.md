...
SSA dominance for values shared by other channels. Profitability additionally
requires a cheap SMEM preparation chain ending in a broadcast of at least 32
elements per thread, using the same shared threshold as
