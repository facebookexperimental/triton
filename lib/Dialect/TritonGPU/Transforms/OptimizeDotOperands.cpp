...
public:
  ...
  LogicalResult matchAndRewrite(ConvertLayoutOp cvtOp,
    ...
    // For NPOT shapes on SM90+, use NVMMASharedEncodingAttr which has proper
    // NPOT support.  SwizzledShared produces XOR-coupled bases incompatible
    // with the modular arithmetic solver.
